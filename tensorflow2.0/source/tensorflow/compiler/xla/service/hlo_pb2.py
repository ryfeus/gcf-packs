...
_HLOINSTRUCTIONPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_call_opaque', full_name='xla.HloInstructionProto.custom_call_opaque', index=25,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outfeed_shape', full_name='xla.HloInstructionProto.outfeed_shape', index=26,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dot_dimension_numbers', full_name='xla.HloInstructionProto.dot_dimension_numbers', index=27,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fft_type', full_name='xla.HloInstructionProto.fft_type', index=28,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fft_length', full_name='xla.HloInstructionProto.fft_length', index=29,
