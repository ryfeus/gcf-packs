...
from tensorflow.python.keras.layers.normalization import disable_v2_batch_normalization
from tensorflow.python.keras.layers.normalization import enable_v2_batch_normalization
