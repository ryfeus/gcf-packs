...
@_kwarg_only
def ExperimentalAssertNextDataset(input_dataset, transformations, output_types, output_shapes):
  return experimental_assert_next_dataset(input_dataset=input_dataset, transformations=transformations, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalAutoShardDataset(input_dataset, num_workers, index, output_types, output_shapes):
  return experimental_auto_shard_dataset(input_dataset=input_dataset, num_workers=num_workers, index=index, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalBytesProducedStatsDataset(input_dataset, tag, output_types, output_shapes):
  return experimental_bytes_produced_stats_dataset(input_dataset=input_dataset, tag=tag, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalCSVDataset(filenames, compression_type, buffer_size, header, field_delim, use_quote_delim, na_value, select_cols, record_defaults, output_shapes):
  return experimental_csv_dataset(filenames=filenames, compression_type=compression_type, buffer_size=buffer_size, header=header, field_delim=field_delim, use_quote_delim=use_quote_delim, na_value=na_value, select_cols=select_cols, record_defaults=record_defaults, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalChooseFastestDataset(input_datasets, num_experiments, output_types, output_shapes):
  return experimental_choose_fastest_dataset(input_datasets=input_datasets, num_experiments=num_experiments, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalDatasetCardinality(input_dataset):
  return experimental_dataset_cardinality(input_dataset=input_dataset)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalDatasetToTFRecord(input_dataset, filename, compression_type):
  return experimental_dataset_to_tf_record(input_dataset=input_dataset, filename=filename, compression_type=compression_type)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalDenseToSparseBatchDataset(input_dataset, batch_size, row_shape, output_types, output_shapes):
  return experimental_dense_to_sparse_batch_dataset(input_dataset=input_dataset, batch_size=batch_size, row_shape=row_shape, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalDirectedInterleaveDataset(selector_input_dataset, data_input_datasets, output_types, output_shapes):
  return experimental_directed_interleave_dataset(selector_input_dataset=selector_input_dataset, data_input_datasets=data_input_datasets, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalGroupByReducerDataset(input_dataset, key_func_other_arguments, init_func_other_arguments, reduce_func_other_arguments, finalize_func_other_arguments, key_func, init_func, reduce_func, finalize_func, output_types, output_shapes):
  return experimental_group_by_reducer_dataset(input_dataset=input_dataset, key_func_other_arguments=key_func_other_arguments, init_func_other_arguments=init_func_other_arguments, reduce_func_other_arguments=reduce_func_other_arguments, finalize_func_other_arguments=finalize_func_other_arguments, key_func=key_func, init_func=init_func, reduce_func=reduce_func, finalize_func=finalize_func, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalGroupByWindowDataset(input_dataset, key_func_other_arguments, reduce_func_other_arguments, window_size_func_other_arguments, key_func, reduce_func, window_size_func, output_types, output_shapes):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalIdentityIndexedDataset(size):
  return experimental_identity_indexed_dataset(size=size)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalIgnoreErrorsDataset(input_dataset, output_types, output_shapes):
  return experimental_ignore_errors_dataset(input_dataset=input_dataset, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalIndexedDatasetGet(materialized, index, output_types, output_shapes):
  return experimental_indexed_dataset_get(materialized=materialized, index=index, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalIndexedDatasetMaterialize(dataset, materialized):
  return experimental_indexed_dataset_materialize(dataset=dataset, materialized=materialized)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalIteratorGetDevice(resource):
  return experimental_iterator_get_device(resource=resource)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalLMDBDataset(filenames, output_types, output_shapes):
  return experimental_lmdb_dataset(filenames=filenames, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalLatencyStatsDataset(input_dataset, tag, output_types, output_shapes):
  return experimental_latency_stats_dataset(input_dataset=input_dataset, tag=tag, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalMapAndBatchDataset(input_dataset, other_arguments, batch_size, num_parallel_calls, drop_remainder, f, output_types, output_shapes, preserve_cardinality):
  return experimental_map_and_batch_dataset(input_dataset=input_dataset, other_arguments=other_arguments, batch_size=batch_size, num_parallel_calls=num_parallel_calls, drop_remainder=drop_remainder, f=f, output_types=output_types, output_shapes=output_shapes, preserve_cardinality=preserve_cardinality)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalMapDataset(input_dataset, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism, preserve_cardinality):
  return experimental_map_dataset(input_dataset=input_dataset, other_arguments=other_arguments, f=f, output_types=output_types, output_shapes=output_shapes, use_inter_op_parallelism=use_inter_op_parallelism, preserve_cardinality=preserve_cardinality)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalMatchingFilesDataset(patterns):
  return experimental_matching_files_dataset(patterns=patterns)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalMaterializedIndexDatasetHandle(container, shared_name, output_types, output_shapes):
  return experimental_materialized_index_dataset_handle(container=container, shared_name=shared_name, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalMaxIntraOpParallelismDataset(input_dataset, max_intra_op_parallelism, output_types, output_shapes):
  return experimental_max_intra_op_parallelism_dataset(input_dataset=input_dataset, max_intra_op_parallelism=max_intra_op_parallelism, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalNonSerializableDataset(input_dataset, output_types, output_shapes):
  return experimental_non_serializable_dataset(input_dataset=input_dataset, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalNumaMapAndBatchDataset(input_dataset, other_arguments, batch_size, num_parallel_calls, drop_remainder, f, output_types, output_shapes, preserve_cardinality):
  return experimental_numa_map_and_batch_dataset(input_dataset=input_dataset, other_arguments=other_arguments, batch_size=batch_size, num_parallel_calls=num_parallel_calls, drop_remainder=drop_remainder, f=f, output_types=output_types, output_shapes=output_shapes, preserve_cardinality=preserve_cardinality)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalParallelInterleaveDataset(input_dataset, other_arguments, cycle_length, block_length, sloppy, buffer_output_elements, prefetch_input_elements, f, output_types, output_shapes):
  return experimental_parallel_interleave_dataset(input_dataset=input_dataset, other_arguments=other_arguments, cycle_length=cycle_length, block_length=block_length, sloppy=sloppy, buffer_output_elements=buffer_output_elements, prefetch_input_elements=prefetch_input_elements, f=f, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalParseExampleDataset(input_dataset, num_parallel_calls, dense_defaults, sparse_keys, dense_keys, sparse_types, dense_shapes, output_types, output_shapes, sloppy):
  return experimental_parse_example_dataset(input_dataset=input_dataset, num_parallel_calls=num_parallel_calls, dense_defaults=dense_defaults, sparse_keys=sparse_keys, dense_keys=dense_keys, sparse_types=sparse_types, dense_shapes=dense_shapes, output_types=output_types, output_shapes=output_shapes, sloppy=sloppy)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalPrivateThreadPoolDataset(input_dataset, num_threads, output_types, output_shapes):
  return experimental_private_thread_pool_dataset(input_dataset=input_dataset, num_threads=num_threads, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalRandomDataset(seed, seed2, output_types, output_shapes):
  return experimental_random_dataset(seed=seed, seed2=seed2, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalRebatchDataset(input_dataset, num_workers, output_types, output_shapes):
  return experimental_rebatch_dataset(input_dataset=input_dataset, num_workers=num_workers, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalScanDataset(input_dataset, initial_state, other_arguments, f, output_types, output_shapes, preserve_cardinality):
  return experimental_scan_dataset(input_dataset=input_dataset, initial_state=initial_state, other_arguments=other_arguments, f=f, output_types=output_types, output_shapes=output_shapes, preserve_cardinality=preserve_cardinality)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalSetStatsAggregatorDataset(input_dataset, stats_aggregator, tag, counter_prefix, output_types, output_shapes):
  return experimental_set_stats_aggregator_dataset(input_dataset=input_dataset, stats_aggregator=stats_aggregator, tag=tag, counter_prefix=counter_prefix, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalSleepDataset(input_dataset, sleep_microseconds, output_types, output_shapes):
  return experimental_sleep_dataset(input_dataset=input_dataset, sleep_microseconds=sleep_microseconds, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalSlidingWindowDataset(input_dataset, window_size, window_shift, window_stride, output_types, output_shapes):
  return experimental_sliding_window_dataset(input_dataset=input_dataset, window_size=window_size, window_shift=window_shift, window_stride=window_stride, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalSqlDataset(driver_name, data_source_name, query, output_types, output_shapes):
  return experimental_sql_dataset(driver_name=driver_name, data_source_name=data_source_name, query=query, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalStatsAggregatorHandle(container, shared_name):
  return experimental_stats_aggregator_handle(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalStatsAggregatorSummary(iterator):
  return experimental_stats_aggregator_summary(iterator=iterator)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalTakeWhileDataset(input_dataset, other_arguments, predicate, output_types, output_shapes):
  return experimental_take_while_dataset(input_dataset=input_dataset, other_arguments=other_arguments, predicate=predicate, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalThreadPoolDataset(input_dataset, thread_pool, output_types, output_shapes):
  return experimental_thread_pool_dataset(input_dataset=input_dataset, thread_pool=thread_pool, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalThreadPoolHandle(num_threads, max_intra_op_parallelism, display_name, container, shared_name):
  return experimental_thread_pool_handle(num_threads=num_threads, max_intra_op_parallelism=max_intra_op_parallelism, display_name=display_name, container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalUnbatchDataset(input_dataset, output_types, output_shapes):
  return experimental_unbatch_dataset(input_dataset=input_dataset, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ExperimentalUniqueDataset(input_dataset, output_types, output_shapes):
  return experimental_unique_dataset(input_dataset=input_dataset, output_types=output_types, output_shapes=output_shapes)
