  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "Assert",
        name, _ctx._post_execution_callbacks, condition, data, "summarize",
        summarize)
      return _result
...
@_kwarg_only
def Assert(condition, data, summarize):
  return _assert(condition=condition, data=data, summarize=summarize)
tf_export("raw_ops.Assert")(Assert)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "AudioSummary", name, _ctx._post_execution_callbacks, tag, tensor,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AudioSummary(tag, tensor, sample_rate, max_outputs):
  return audio_summary(tag=tag, tensor=tensor, sample_rate=sample_rate, max_outputs=max_outputs)
tf_export("raw_ops.AudioSummary")(AudioSummary)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AudioSummaryV2(tag, tensor, sample_rate, max_outputs):
  return audio_summary_v2(tag=tag, tensor=tensor, sample_rate=sample_rate, max_outputs=max_outputs)
tf_export("raw_ops.AudioSummaryV2")(AudioSummaryV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def HistogramSummary(tag, values):
  return histogram_summary(tag=tag, values=values)
tf_export("raw_ops.HistogramSummary")(HistogramSummary)
  ...
  *  If `max_images` is greater than 1, the summary value tags are
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ImageSummary", name, _ctx._post_execution_callbacks, tag, tensor,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ImageSummary(tag, tensor, max_images, bad_color):
  return image_summary(tag=tag, tensor=tensor, max_images=max_images, bad_color=bad_color)
tf_export("raw_ops.ImageSummary")(ImageSummary)
...
def merge_summary(inputs, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MergeSummary", name, _ctx._post_execution_callbacks, inputs)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MergeSummary(inputs):
  return merge_summary(inputs=inputs)
tf_export("raw_ops.MergeSummary")(MergeSummary)
...
def _print(input, data, message="", first_n=-1, summarize=3, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "Print",
        name, _ctx._post_execution_callbacks, input, data, "message", message,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Print(input, data, message, first_n, summarize):
  return _print(input=input, data=data, message=message, first_n=first_n, summarize=summarize)
tf_export("raw_ops.Print")(Print)
...
def print_v2(input, output_stream="stderr", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "PrintV2",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PrintV2(input, output_stream):
  return print_v2(input=input, output_stream=output_stream)
tf_export("raw_ops.PrintV2")(PrintV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScalarSummary(tags, values):
  return scalar_summary(tags=tags, values=values)
tf_export("raw_ops.ScalarSummary")(ScalarSummary)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorSummary(tensor, description, labels, display_name):
  return tensor_summary(tensor=tensor, description=description, labels=labels, display_name=display_name)
tf_export("raw_ops.TensorSummary")(TensorSummary)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorSummaryV2(tag, tensor, serialized_summary_metadata):
  return tensor_summary_v2(tag=tag, tensor=tensor, serialized_summary_metadata=serialized_summary_metadata)
tf_export("raw_ops.TensorSummaryV2")(TensorSummaryV2)
...
def timestamp(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Timestamp", name, _ctx._post_execution_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
def Timestamp():
  return timestamp()
tf_export("raw_ops.Timestamp")(Timestamp)
