...
@_kwarg_only
def AllCandidateSampler(true_classes, num_true, num_sampled, unique, seed, seed2):
  return all_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, seed=seed, seed2=seed2)
tf_export("raw_ops.AllCandidateSampler")(AllCandidateSampler)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ComputeAccidentalHits(true_classes, sampled_candidates, num_true, seed, seed2):
  return compute_accidental_hits(true_classes=true_classes, sampled_candidates=sampled_candidates, num_true=num_true, seed=seed, seed2=seed2)
tf_export("raw_ops.ComputeAccidentalHits")(ComputeAccidentalHits)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FixedUnigramCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, vocab_file, distortion, num_reserved_ids, num_shards, shard, unigrams, seed, seed2):
  return fixed_unigram_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, vocab_file=vocab_file, distortion=distortion, num_reserved_ids=num_reserved_ids, num_shards=num_shards, shard=shard, unigrams=unigrams, seed=seed, seed2=seed2)
tf_export("raw_ops.FixedUnigramCandidateSampler")(FixedUnigramCandidateSampler)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LearnedUnigramCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed, seed2):
  return learned_unigram_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2)
tf_export("raw_ops.LearnedUnigramCandidateSampler")(LearnedUnigramCandidateSampler)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LogUniformCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed, seed2):
  return log_uniform_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2)
tf_export("raw_ops.LogUniformCandidateSampler")(LogUniformCandidateSampler)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ThreadUnsafeUnigramCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed, seed2):
  return thread_unsafe_unigram_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2)
tf_export("raw_ops.ThreadUnsafeUnigramCandidateSampler")(ThreadUnsafeUnigramCandidateSampler)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UniformCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed, seed2):
  return uniform_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2)
tf_export("raw_ops.UniformCandidateSampler")(UniformCandidateSampler)
