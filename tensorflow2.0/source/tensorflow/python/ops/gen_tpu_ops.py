...
@_kwarg_only
def AllToAll(input, group_assignment, concat_dimension, split_dimension, split_count):
  return all_to_all(input=input, group_assignment=group_assignment, concat_dimension=concat_dimension, split_dimension=split_dimension, split_count=split_count)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CollectivePermute(input, source_target_pairs):
  return collective_permute(input=input, source_target_pairs=source_target_pairs)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ConfigureDistributedTPU(embedding_config, tpu_embedding_config, is_global_init):
  return configure_distributed_tpu(embedding_config=embedding_config, tpu_embedding_config=tpu_embedding_config, is_global_init=is_global_init)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CrossReplicaSum(input, group_assignment):
  return cross_replica_sum(input=input, group_assignment=group_assignment)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def EnqueueTPUEmbeddingIntegerBatch(batch, mode_override, device_ordinal):
  return enqueue_tpu_embedding_integer_batch(batch=batch, mode_override=mode_override, device_ordinal=device_ordinal)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def EnqueueTPUEmbeddingSparseBatch(sample_indices, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners):
  return enqueue_tpu_embedding_sparse_batch(sample_indices=sample_indices, embedding_indices=embedding_indices, aggregation_weights=aggregation_weights, mode_override=mode_override, device_ordinal=device_ordinal, combiners=combiners)
...
def enqueue_tpu_embedding_sparse_tensor_batch(sample_indices, embedding_indices, aggregation_weights, mode_override, table_ids, device_ordinal=-1, combiners=[], name=None):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def EnqueueTPUEmbeddingSparseTensorBatch(sample_indices, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners, table_ids):
  return enqueue_tpu_embedding_sparse_tensor_batch(sample_indices=sample_indices, embedding_indices=embedding_indices, aggregation_weights=aggregation_weights, mode_override=mode_override, device_ordinal=device_ordinal, combiners=combiners, table_ids=table_ids)
tf_export("raw_ops.EnqueueTPUEmbeddingSparseTensorBatch")(EnqueueTPUEmbeddingSparseTensorBatch)


def enqueue_tpu_embedding_sparse_tensor_batch_eager_fallback(sample_indices, embedding_indices, aggregation_weights, mode_override, table_ids, device_ordinal=-1, combiners=[], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InfeedDequeue(dtype, shape):
  return infeed_dequeue(dtype=dtype, shape=shape)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InfeedDequeueTuple(dtypes, shapes):
  return infeed_dequeue_tuple(dtypes=dtypes, shapes=shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InfeedEnqueue(input, shape, layout, device_ordinal):
  return infeed_enqueue(input=input, shape=shape, layout=layout, device_ordinal=device_ordinal)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InfeedEnqueueTuple(inputs, shapes, layouts, device_ordinal):
  return infeed_enqueue_tuple(inputs=inputs, shapes=shapes, layouts=layouts, device_ordinal=device_ordinal)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingADAMParameters(parameters, momenta, velocities, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_adam_parameters(parameters=parameters, momenta=momenta, velocities=velocities, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingADAMParametersGradAccumDebug(parameters, momenta, velocities, gradient_accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_adam_parameters_grad_accum_debug(parameters=parameters, momenta=momenta, velocities=velocities, gradient_accumulators=gradient_accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingAdadeltaParameters(parameters, accumulators, updates, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_adadelta_parameters(parameters=parameters, accumulators=accumulators, updates=updates, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingAdadeltaParametersGradAccumDebug(parameters, accumulators, updates, gradient_accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_adadelta_parameters_grad_accum_debug(parameters=parameters, accumulators=accumulators, updates=updates, gradient_accumulators=gradient_accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingAdagradParameters(parameters, accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_adagrad_parameters(parameters=parameters, accumulators=accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingAdagradParametersGradAccumDebug(parameters, accumulators, gradient_accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_adagrad_parameters_grad_accum_debug(parameters=parameters, accumulators=accumulators, gradient_accumulators=gradient_accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingCenteredRMSPropParameters(parameters, ms, mom, mg, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_centered_rms_prop_parameters(parameters=parameters, ms=ms, mom=mom, mg=mg, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingFTRLParameters(parameters, accumulators, linears, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_ftrl_parameters(parameters=parameters, accumulators=accumulators, linears=linears, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingFTRLParametersGradAccumDebug(parameters, accumulators, linears, gradient_accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_ftrl_parameters_grad_accum_debug(parameters=parameters, accumulators=accumulators, linears=linears, gradient_accumulators=gradient_accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingMDLAdagradLightParameters(parameters, accumulators, weights, benefits, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_mdl_adagrad_light_parameters(parameters=parameters, accumulators=accumulators, weights=weights, benefits=benefits, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingMomentumParameters(parameters, momenta, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_momentum_parameters(parameters=parameters, momenta=momenta, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingMomentumParametersGradAccumDebug(parameters, momenta, gradient_accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_momentum_parameters_grad_accum_debug(parameters=parameters, momenta=momenta, gradient_accumulators=gradient_accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingProximalAdagradParameters(parameters, accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_proximal_adagrad_parameters(parameters=parameters, accumulators=accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingProximalAdagradParametersGradAccumDebug(parameters, accumulators, gradient_accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug(parameters=parameters, accumulators=accumulators, gradient_accumulators=gradient_accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingRMSPropParameters(parameters, ms, mom, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_rms_prop_parameters(parameters=parameters, ms=ms, mom=mom, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingRMSPropParametersGradAccumDebug(parameters, ms, mom, gradient_accumulators, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_rms_prop_parameters_grad_accum_debug(parameters=parameters, ms=ms, mom=mom, gradient_accumulators=gradient_accumulators, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LoadTPUEmbeddingStochasticGradientDescentParameters(parameters, table_id, table_name, num_shards, shard_id):
  return load_tpu_embedding_stochastic_gradient_descent_parameters(parameters=parameters, table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OutfeedDequeue(dtype, shape, device_ordinal):
  return outfeed_dequeue(dtype=dtype, shape=shape, device_ordinal=device_ordinal)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OutfeedDequeueTuple(dtypes, shapes, device_ordinal):
  return outfeed_dequeue_tuple(dtypes=dtypes, shapes=shapes, device_ordinal=device_ordinal)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OutfeedEnqueue(input):
  return outfeed_enqueue(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OutfeedEnqueueTuple(inputs):
  return outfeed_enqueue_tuple(inputs=inputs)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RecvTPUEmbeddingActivations(num_outputs, config):
  return recv_tpu_embedding_activations(num_outputs=num_outputs, config=config)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingADAMParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_adam_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingADAMParametersGradAccumDebug(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_adam_parameters_grad_accum_debug(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingAdadeltaParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_adadelta_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingAdadeltaParametersGradAccumDebug(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_adadelta_parameters_grad_accum_debug(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingAdagradParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_adagrad_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingAdagradParametersGradAccumDebug(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_adagrad_parameters_grad_accum_debug(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingCenteredRMSPropParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_centered_rms_prop_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingFTRLParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_ftrl_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingFTRLParametersGradAccumDebug(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_ftrl_parameters_grad_accum_debug(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingMDLAdagradLightParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_mdl_adagrad_light_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingMomentumParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_momentum_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingMomentumParametersGradAccumDebug(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_momentum_parameters_grad_accum_debug(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingProximalAdagradParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_proximal_adagrad_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingRMSPropParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_rms_prop_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_rms_prop_parameters_grad_accum_debug(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RetrieveTPUEmbeddingStochasticGradientDescentParameters(table_id, table_name, num_shards, shard_id):
  return retrieve_tpu_embedding_stochastic_gradient_descent_parameters(table_id=table_id, table_name=table_name, num_shards=num_shards, shard_id=shard_id)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SendTPUEmbeddingGradients(inputs, learning_rates, config):
  return send_tpu_embedding_gradients(inputs=inputs, learning_rates=learning_rates, config=config)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TPUEmbeddingActivations(embedding_variable, sliced_activations, table_id, lookup_id):
  return tpu_embedding_activations(embedding_variable=embedding_variable, sliced_activations=sliced_activations, table_id=table_id, lookup_id=lookup_id)
...
def tpu_ordinal_selector(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TPUOrdinalSelector", name, _ctx._post_execution_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TPUOrdinalSelector():
  return tpu_ordinal_selector()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TPUPartitionedCall(args, device_ordinal, Tout, f):
  return tpu_partitioned_call(args=args, device_ordinal=device_ordinal, Tout=Tout, f=f)
...
def tpu_replicate(inputs, broadcast_inputs, variables, guaranteed_constants, computation, num_replicas, output_types, num_cores_per_replica=1, topology="", use_tpu=True, device_assignment=[], host_compute_core=[], padding_map=[], step_marker_location="STEP_MARK_AT_ENTRY", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TPUReplicate", name, _ctx._post_execution_callbacks, inputs,
        broadcast_inputs, variables, guaranteed_constants, "computation",
        computation, "num_replicas", num_replicas, "num_cores_per_replica",
        num_cores_per_replica, "topology", topology, "use_tpu", use_tpu,
        "device_assignment", device_assignment, "host_compute_core",
        host_compute_core, "output_types", output_types, "padding_map",
      ...
      try:
        return tpu_replicate_eager_fallback(
            ...
            step_marker_location=step_marker_location, name=name, ctx=_ctx)
      except _core._SymbolicException:
        pass  # Add nodes to the TensorFlow graph.
    except _core._NotOkStatusException as e:
      if name is not None:
  ...
  if not isinstance(padding_map, (list, tuple)):
    raise TypeError(
        ...
        "'tpu_replicate' Op, not %r." % padding_map)
  ...
  _, _, _op = _op_def_lib._apply_op_helper(
        "TPUReplicate", inputs=inputs, broadcast_inputs=broadcast_inputs,
                        ...
                        padding_map=padding_map,
                        step_marker_location=step_marker_location, name=name)
  _result = _op.outputs[:]
  if not _result:
    return _op
  _inputs_flat = _op.inputs
  _attrs = ("computation", _op.get_attr("computation"), "num_replicas",
            ...
            _op.get_attr("output_types"), "padding_map",
            _op.get_attr("padding_map"), "step_marker_location",
            _op.get_attr("step_marker_location"))
  _execute.record_gradient(
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TPUReplicate(inputs, broadcast_inputs, variables, guaranteed_constants, computation, num_replicas, num_cores_per_replica, topology, use_tpu, device_assignment, host_compute_core, output_types, padding_map, step_marker_location):
  return tpu_replicate(inputs=inputs, broadcast_inputs=broadcast_inputs, variables=variables, guaranteed_constants=guaranteed_constants, computation=computation, num_replicas=num_replicas, num_cores_per_replica=num_cores_per_replica, topology=topology, use_tpu=use_tpu, device_assignment=device_assignment, host_compute_core=host_compute_core, output_types=output_types, padding_map=padding_map, step_marker_location=step_marker_location)
tf_export("raw_ops.TPUReplicate")(TPUReplicate)


def tpu_replicate_eager_fallback(inputs, broadcast_inputs, variables, guaranteed_constants, computation, num_replicas, output_types, num_cores_per_replica=1, topology="", use_tpu=True, device_assignment=[], host_compute_core=[], padding_map=[], step_marker_location="STEP_MARK_AT_ENTRY", name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  ...
  "output_types", output_types, "padding_map", padding_map,
...
def tpu_replicate_metadata(num_replicas, num_cores_per_replica=1, topology="", use_tpu=True, device_assignment=[], computation_shape=[], host_compute_core=[], padding_map=[], step_marker_location="STEP_MARK_AT_ENTRY", name=None):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TPUReplicateMetadata(num_replicas, num_cores_per_replica, topology, use_tpu, device_assignment, computation_shape, host_compute_core, padding_map, step_marker_location):
...
def tpu_replicate_metadata_eager_fallback(num_replicas, num_cores_per_replica=1, topology="", use_tpu=True, device_assignment=[], computation_shape=[], host_compute_core=[], padding_map=[], step_marker_location="STEP_MARK_AT_ENTRY", name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TPUReplicatedInput(inputs):
  return tpu_replicated_input(inputs=inputs)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TPUReplicatedOutput(input, num_replicas):
  return tpu_replicated_output(input=input, num_replicas=num_replicas)
...
def WorkerHeartbeat(request):
  return worker_heartbeat(request=request)
