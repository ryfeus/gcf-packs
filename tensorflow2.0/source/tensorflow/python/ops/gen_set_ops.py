...
@_kwarg_only
def DenseToDenseSetOperation(set1, set2, set_operation, validate_indices):
  return dense_to_dense_set_operation(set1=set1, set2=set2, set_operation=set_operation, validate_indices=validate_indices)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DenseToSparseSetOperation(set1, set2_indices, set2_values, set2_shape, set_operation, validate_indices):
  return dense_to_sparse_set_operation(set1=set1, set2_indices=set2_indices, set2_values=set2_values, set2_shape=set2_shape, set_operation=set_operation, validate_indices=validate_indices)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SetSize(set_indices, set_values, set_shape, validate_indices):
  return set_size(set_indices=set_indices, set_values=set_values, set_shape=set_shape, validate_indices=validate_indices)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseToSparseSetOperation(set1_indices, set1_values, set1_shape, set2_indices, set2_values, set2_shape, set_operation, validate_indices):
  return sparse_to_sparse_set_operation(set1_indices=set1_indices, set1_values=set1_values, set1_shape=set1_shape, set2_indices=set2_indices, set2_values=set2_values, set2_shape=set2_shape, set_operation=set_operation, validate_indices=validate_indices)
