...
@_kwarg_only
def AssignAddVariableOp(resource, value):
  return assign_add_variable_op(resource=resource, value=value)
tf_export("raw_ops.AssignAddVariableOp")(AssignAddVariableOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AssignSubVariableOp(resource, value):
  return assign_sub_variable_op(resource=resource, value=value)
tf_export("raw_ops.AssignSubVariableOp")(AssignSubVariableOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AssignVariableOp(resource, value):
  return assign_variable_op(resource=resource, value=value)
tf_export("raw_ops.AssignVariableOp")(AssignVariableOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ConsumeMutexLock(mutex_lock):
  return consume_mutex_lock(mutex_lock=mutex_lock)
tf_export("raw_ops.ConsumeMutexLock")(ConsumeMutexLock)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DestroyResourceOp(resource, ignore_lookup_error):
  return destroy_resource_op(resource=resource, ignore_lookup_error=ignore_lookup_error)
tf_export("raw_ops.DestroyResourceOp")(DestroyResourceOp)
...
def mutex_lock(mutex, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MutexLock", name, _ctx._post_execution_callbacks, mutex)
      return _result
    except _core._FallbackException:
      try:
...
tf_export("raw_ops.MutexLock")(MutexLock)
...
def mutex_v2(container="", shared_name="", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "MutexV2",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MutexV2(container, shared_name):
  return mutex_v2(container=container, shared_name=shared_name)
tf_export("raw_ops.MutexV2")(MutexV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReadVariableOp(resource, dtype):
  return read_variable_op(resource=resource, dtype=dtype)
tf_export("raw_ops.ReadVariableOp")(ReadVariableOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceGather(resource, indices, validate_indices, dtype):
  return resource_gather(resource=resource, indices=indices, validate_indices=validate_indices, dtype=dtype)
tf_export("raw_ops.ResourceGather")(ResourceGather)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterAdd(resource, indices, updates):
  return resource_scatter_add(resource=resource, indices=indices, updates=updates)
tf_export("raw_ops.ResourceScatterAdd")(ResourceScatterAdd)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterDiv(resource, indices, updates):
  return resource_scatter_div(resource=resource, indices=indices, updates=updates)
tf_export("raw_ops.ResourceScatterDiv")(ResourceScatterDiv)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterMax(resource, indices, updates):
  return resource_scatter_max(resource=resource, indices=indices, updates=updates)
tf_export("raw_ops.ResourceScatterMax")(ResourceScatterMax)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterMin(resource, indices, updates):
  return resource_scatter_min(resource=resource, indices=indices, updates=updates)
tf_export("raw_ops.ResourceScatterMin")(ResourceScatterMin)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterMul(resource, indices, updates):
  return resource_scatter_mul(resource=resource, indices=indices, updates=updates)
tf_export("raw_ops.ResourceScatterMul")(ResourceScatterMul)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterSub(resource, indices, updates):
  return resource_scatter_sub(resource=resource, indices=indices, updates=updates)
tf_export("raw_ops.ResourceScatterSub")(ResourceScatterSub)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterUpdate(resource, indices, updates):
  return resource_scatter_update(resource=resource, indices=indices, updates=updates)
tf_export("raw_ops.ResourceScatterUpdate")(ResourceScatterUpdate)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def VarHandleOp(container, shared_name, dtype, shape):
  return var_handle_op(container=container, shared_name=shared_name, dtype=dtype, shape=shape)
tf_export("raw_ops.VarHandleOp")(VarHandleOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def VarIsInitializedOp(resource):
  return var_is_initialized_op(resource=resource)
tf_export("raw_ops.VarIsInitializedOp")(VarIsInitializedOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def VariableShape(input, out_type):
  return variable_shape(input=input, out_type=out_type)
tf_export("raw_ops.VariableShape")(VariableShape)
