...
@_kwarg_only
def BatchCholesky(input):
  return batch_cholesky(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchCholeskyGrad(l, grad):
  return batch_cholesky_grad(l=l, grad=grad)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchMatrixDeterminant(input):
  return batch_matrix_determinant(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchMatrixInverse(input, adjoint):
  return batch_matrix_inverse(input=input, adjoint=adjoint)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchMatrixSolve(matrix, rhs, adjoint):
  return batch_matrix_solve(matrix=matrix, rhs=rhs, adjoint=adjoint)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchMatrixSolveLs(matrix, rhs, l2_regularizer, fast):
  return batch_matrix_solve_ls(matrix=matrix, rhs=rhs, l2_regularizer=l2_regularizer, fast=fast)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchMatrixTriangularSolve(matrix, rhs, lower, adjoint):
  return batch_matrix_triangular_solve(matrix=matrix, rhs=rhs, lower=lower, adjoint=adjoint)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchSelfAdjointEig(input):
  return batch_self_adjoint_eig(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchSelfAdjointEigV2(input, compute_v):
  return batch_self_adjoint_eig_v2(input=input, compute_v=compute_v)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchSvd(input, compute_uv, full_matrices):
  return batch_svd(input=input, compute_uv=compute_uv, full_matrices=full_matrices)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CholeskyGrad(l, grad):
  return cholesky_grad(l=l, grad=grad)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LogMatrixDeterminant(input):
  return log_matrix_determinant(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Lu(input, output_idx_type):
  return lu(input=input, output_idx_type=output_idx_type)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixDeterminant(input):
  return matrix_determinant(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixExponential(input):
  return matrix_exponential(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixInverse(input, adjoint):
  return matrix_inverse(input=input, adjoint=adjoint)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixLogarithm(input):
  return matrix_logarithm(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixSolve(matrix, rhs, adjoint):
  return matrix_solve(matrix=matrix, rhs=rhs, adjoint=adjoint)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixSolveLs(matrix, rhs, l2_regularizer, fast):
  return matrix_solve_ls(matrix=matrix, rhs=rhs, l2_regularizer=l2_regularizer, fast=fast)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixSquareRoot(input):
  return matrix_square_root(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MatrixTriangularSolve(matrix, rhs, lower, adjoint):
  return matrix_triangular_solve(matrix=matrix, rhs=rhs, lower=lower, adjoint=adjoint)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Qr(input, full_matrices):
  return qr(input=input, full_matrices=full_matrices)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SelfAdjointEig(input):
  return self_adjoint_eig(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SelfAdjointEigV2(input, compute_v):
  return self_adjoint_eig_v2(input=input, compute_v=compute_v)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Svd(input, compute_uv, full_matrices):
  return svd(input=input, compute_uv=compute_uv, full_matrices=full_matrices)
...
def tridiagonal_solve(diagonals, rhs, name=None):
    ...
    try:
      ...
      try:
        return tridiagonal_solve_eager_fallback(
            diagonals, rhs, name=name, ctx=_ctx)
      except _core._SymbolicException:
        pass  # Add nodes to the TensorFlow graph.
    except _core._NotOkStatusException as e:
      if name is not None:
  ...
  # Add nodes to the TensorFlow graph.
  _, _, _op = _op_def_lib._apply_op_helper(
        "TridiagonalSolve", diagonals=diagonals, rhs=rhs, name=name)
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
  _attrs = ("T", _op.get_attr("T"))
  _execute.record_gradient(
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TridiagonalSolve(diagonals, rhs):
  return tridiagonal_solve(diagonals=diagonals, rhs=rhs)
tf_export("raw_ops.TridiagonalSolve")(TridiagonalSolve)


def tridiagonal_solve_eager_fallback(diagonals, rhs, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
