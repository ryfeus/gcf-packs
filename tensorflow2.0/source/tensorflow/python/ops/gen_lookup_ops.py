...
@_kwarg_only
def HashTable(container, shared_name, use_node_name_sharing, key_dtype, value_dtype):
  return hash_table(container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, key_dtype=key_dtype, value_dtype=value_dtype)
tf_export("raw_ops.HashTable")(HashTable)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "HashTableV2", name, _ctx._post_execution_callbacks, "container",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def HashTableV2(container, shared_name, use_node_name_sharing, key_dtype, value_dtype):
  return hash_table_v2(container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, key_dtype=key_dtype, value_dtype=value_dtype)
tf_export("raw_ops.HashTableV2")(HashTableV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InitializeTable(table_handle, keys, values):
  return initialize_table(table_handle=table_handle, keys=keys, values=values)
tf_export("raw_ops.InitializeTable")(InitializeTable)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InitializeTableFromTextFile(table_handle, filename, key_index, value_index, vocab_size, delimiter):
  return initialize_table_from_text_file(table_handle=table_handle, filename=filename, key_index=key_index, value_index=value_index, vocab_size=vocab_size, delimiter=delimiter)
tf_export("raw_ops.InitializeTableFromTextFile")(InitializeTableFromTextFile)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InitializeTableFromTextFileV2(table_handle, filename, key_index, value_index, vocab_size, delimiter):
  return initialize_table_from_text_file_v2(table_handle=table_handle, filename=filename, key_index=key_index, value_index=value_index, vocab_size=vocab_size, delimiter=delimiter)
tf_export("raw_ops.InitializeTableFromTextFileV2")(InitializeTableFromTextFileV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InitializeTableV2(table_handle, keys, values):
  return initialize_table_v2(table_handle=table_handle, keys=keys, values=values)
tf_export("raw_ops.InitializeTableV2")(InitializeTableV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableExport(table_handle, Tkeys, Tvalues):
  return lookup_table_export(table_handle=table_handle, Tkeys=Tkeys, Tvalues=Tvalues)
tf_export("raw_ops.LookupTableExport")(LookupTableExport)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableExportV2(table_handle, Tkeys, Tvalues):
  return lookup_table_export_v2(table_handle=table_handle, Tkeys=Tkeys, Tvalues=Tvalues)
tf_export("raw_ops.LookupTableExportV2")(LookupTableExportV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableFind(table_handle, keys, default_value):
  return lookup_table_find(table_handle=table_handle, keys=keys, default_value=default_value)
tf_export("raw_ops.LookupTableFind")(LookupTableFind)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableFindV2(table_handle, keys, default_value):
  return lookup_table_find_v2(table_handle=table_handle, keys=keys, default_value=default_value)
tf_export("raw_ops.LookupTableFindV2")(LookupTableFindV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableImport(table_handle, keys, values):
  return lookup_table_import(table_handle=table_handle, keys=keys, values=values)
tf_export("raw_ops.LookupTableImport")(LookupTableImport)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableImportV2(table_handle, keys, values):
  return lookup_table_import_v2(table_handle=table_handle, keys=keys, values=values)
tf_export("raw_ops.LookupTableImportV2")(LookupTableImportV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableInsert(table_handle, keys, values):
  return lookup_table_insert(table_handle=table_handle, keys=keys, values=values)
tf_export("raw_ops.LookupTableInsert")(LookupTableInsert)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableInsertV2(table_handle, keys, values):
  return lookup_table_insert_v2(table_handle=table_handle, keys=keys, values=values)
tf_export("raw_ops.LookupTableInsertV2")(LookupTableInsertV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableRemoveV2(table_handle, keys):
  return lookup_table_remove_v2(table_handle=table_handle, keys=keys)
tf_export("raw_ops.LookupTableRemoveV2")(LookupTableRemoveV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableSize(table_handle):
  return lookup_table_size(table_handle=table_handle)
tf_export("raw_ops.LookupTableSize")(LookupTableSize)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LookupTableSizeV2(table_handle):
  return lookup_table_size_v2(table_handle=table_handle)
tf_export("raw_ops.LookupTableSizeV2")(LookupTableSizeV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MutableDenseHashTable(empty_key, container, shared_name, use_node_name_sharing, value_dtype, value_shape, initial_num_buckets, max_load_factor):
  return mutable_dense_hash_table(empty_key=empty_key, container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, value_dtype=value_dtype, value_shape=value_shape, initial_num_buckets=initial_num_buckets, max_load_factor=max_load_factor)
tf_export("raw_ops.MutableDenseHashTable")(MutableDenseHashTable)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MutableDenseHashTableV2(empty_key, deleted_key, container, shared_name, use_node_name_sharing, value_dtype, value_shape, initial_num_buckets, max_load_factor):
  return mutable_dense_hash_table_v2(empty_key=empty_key, deleted_key=deleted_key, container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, value_dtype=value_dtype, value_shape=value_shape, initial_num_buckets=initial_num_buckets, max_load_factor=max_load_factor)
tf_export("raw_ops.MutableDenseHashTableV2")(MutableDenseHashTableV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MutableHashTable(container, shared_name, use_node_name_sharing, key_dtype, value_dtype):
  return mutable_hash_table(container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, key_dtype=key_dtype, value_dtype=value_dtype)
tf_export("raw_ops.MutableHashTable")(MutableHashTable)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MutableHashTableOfTensors(container, shared_name, use_node_name_sharing, key_dtype, value_dtype, value_shape):
  return mutable_hash_table_of_tensors(container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, key_dtype=key_dtype, value_dtype=value_dtype, value_shape=value_shape)
tf_export("raw_ops.MutableHashTableOfTensors")(MutableHashTableOfTensors)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MutableHashTableOfTensorsV2(container, shared_name, use_node_name_sharing, key_dtype, value_dtype, value_shape):
  return mutable_hash_table_of_tensors_v2(container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, key_dtype=key_dtype, value_dtype=value_dtype, value_shape=value_shape)
tf_export("raw_ops.MutableHashTableOfTensorsV2")(MutableHashTableOfTensorsV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MutableHashTableV2(container, shared_name, use_node_name_sharing, key_dtype, value_dtype):
  return mutable_hash_table_v2(container=container, shared_name=shared_name, use_node_name_sharing=use_node_name_sharing, key_dtype=key_dtype, value_dtype=value_dtype)
tf_export("raw_ops.MutableHashTableV2")(MutableHashTableV2)
