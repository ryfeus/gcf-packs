...
@_kwarg_only
def AnonymousIterator(output_types, output_shapes):
  return anonymous_iterator(output_types=output_types, output_shapes=output_shapes)
...
def batch_dataset(input_dataset, batch_size, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "BatchDataset", name, _ctx._post_execution_callbacks, input_dataset,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchDataset(input_dataset, batch_size, output_types, output_shapes):
  return batch_dataset(input_dataset=input_dataset, batch_size=batch_size, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchDatasetV2(input_dataset, batch_size, drop_remainder, output_types, output_shapes):
  return batch_dataset_v2(input_dataset=input_dataset, batch_size=batch_size, drop_remainder=drop_remainder, output_types=output_types, output_shapes=output_shapes)
...
def cache_dataset(input_dataset, filename, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "CacheDataset", name, _ctx._post_execution_callbacks, input_dataset,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CacheDataset(input_dataset, filename, output_types, output_shapes):
  return cache_dataset(input_dataset=input_dataset, filename=filename, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ConcatenateDataset(input_dataset, another_dataset, output_types, output_shapes):
  return concatenate_dataset(input_dataset=input_dataset, another_dataset=another_dataset, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DatasetToGraph(input_dataset):
  return dataset_to_graph(input_dataset=input_dataset)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DatasetToSingleElement(dataset, output_types, output_shapes):
  return dataset_to_single_element(dataset=dataset, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DeserializeIterator(resource_handle, serialized):
  return deserialize_iterator(resource_handle=resource_handle, serialized=serialized)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FilterByLastComponentDataset(input_dataset, output_types, output_shapes):
  return filter_by_last_component_dataset(input_dataset=input_dataset, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FilterDataset(input_dataset, other_arguments, predicate, output_types, output_shapes):
  return filter_dataset(input_dataset=input_dataset, other_arguments=other_arguments, predicate=predicate, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FixedLengthRecordDataset(filenames, header_bytes, record_bytes, footer_bytes, buffer_size):
  return fixed_length_record_dataset(filenames=filenames, header_bytes=header_bytes, record_bytes=record_bytes, footer_bytes=footer_bytes, buffer_size=buffer_size)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FixedLengthRecordDatasetV2(filenames, header_bytes, record_bytes, footer_bytes, buffer_size, compression_type):
  return fixed_length_record_dataset_v2(filenames=filenames, header_bytes=header_bytes, record_bytes=record_bytes, footer_bytes=footer_bytes, buffer_size=buffer_size, compression_type=compression_type)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FlatMapDataset(input_dataset, other_arguments, f, output_types, output_shapes):
  return flat_map_dataset(input_dataset=input_dataset, other_arguments=other_arguments, f=f, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def GeneratorDataset(init_func_other_args, next_func_other_args, finalize_func_other_args, init_func, next_func, finalize_func, output_types, output_shapes):
  return generator_dataset(init_func_other_args=init_func_other_args, next_func_other_args=next_func_other_args, finalize_func_other_args=finalize_func_other_args, init_func=init_func, next_func=next_func, finalize_func=finalize_func, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InterleaveDataset(input_dataset, other_arguments, cycle_length, block_length, f, output_types, output_shapes):
  return interleave_dataset(input_dataset=input_dataset, other_arguments=other_arguments, cycle_length=cycle_length, block_length=block_length, f=f, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Iterator(shared_name, container, output_types, output_shapes):
  return iterator(shared_name=shared_name, container=container, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IteratorFromStringHandle(string_handle, output_types, output_shapes):
  return iterator_from_string_handle(string_handle=string_handle, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IteratorFromStringHandleV2(string_handle, output_types, output_shapes):
  return iterator_from_string_handle_v2(string_handle=string_handle, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IteratorGetNext(iterator, output_types, output_shapes):
  return iterator_get_next(iterator=iterator, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IteratorGetNextAsOptional(iterator, output_types, output_shapes):
  return iterator_get_next_as_optional(iterator=iterator, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IteratorGetNextSync(iterator, output_types, output_shapes):
  return iterator_get_next_sync(iterator=iterator, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IteratorToStringHandle(resource_handle):
  return iterator_to_string_handle(resource_handle=resource_handle)
...
def iterator_v2(shared_name, container, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "IteratorV2", name, _ctx._post_execution_callbacks, "shared_name",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IteratorV2(shared_name, container, output_types, output_shapes):
  return iterator_v2(shared_name=shared_name, container=container, output_types=output_types, output_shapes=output_shapes)
...
def make_iterator(dataset, iterator, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MakeIterator", name, _ctx._post_execution_callbacks, dataset,
        iterator)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MakeIterator(dataset, iterator):
  return make_iterator(dataset=dataset, iterator=iterator)
...
def map_dataset(input_dataset, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism=True, preserve_cardinality=False, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MapDataset", name, _ctx._post_execution_callbacks, input_dataset,
        other_arguments, "f", f, "output_types", output_types,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MapDataset(input_dataset, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism, preserve_cardinality):
  return map_dataset(input_dataset=input_dataset, other_arguments=other_arguments, f=f, output_types=output_types, output_shapes=output_shapes, use_inter_op_parallelism=use_inter_op_parallelism, preserve_cardinality=preserve_cardinality)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MapDefun(arguments, captured_inputs, output_types, output_shapes, f):
  return map_defun(arguments=arguments, captured_inputs=captured_inputs, output_types=output_types, output_shapes=output_shapes, f=f)
...
def model_dataset(input_dataset, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ModelDataset", name, _ctx._post_execution_callbacks, input_dataset,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ModelDataset(input_dataset, output_types, output_shapes):
  return model_dataset(input_dataset=input_dataset, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MultiDeviceIterator(devices, shared_name, container, output_types, output_shapes):
  return multi_device_iterator(devices=devices, shared_name=shared_name, container=container, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MultiDeviceIteratorFromStringHandle(string_handle, output_types, output_shapes):
  return multi_device_iterator_from_string_handle(string_handle=string_handle, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MultiDeviceIteratorGetNextFromShard(multi_device_iterator, shard_num, incarnation_id, output_types, output_shapes):
  return multi_device_iterator_get_next_from_shard(multi_device_iterator=multi_device_iterator, shard_num=shard_num, incarnation_id=incarnation_id, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MultiDeviceIteratorInit(dataset, multi_device_iterator, max_buffer_size):
  return multi_device_iterator_init(dataset=dataset, multi_device_iterator=multi_device_iterator, max_buffer_size=max_buffer_size)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MultiDeviceIteratorToStringHandle(multi_device_iterator):
  return multi_device_iterator_to_string_handle(multi_device_iterator=multi_device_iterator)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OneShotIterator(dataset_factory, output_types, output_shapes, container, shared_name):
  return one_shot_iterator(dataset_factory=dataset_factory, output_types=output_types, output_shapes=output_shapes, container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OptimizeDataset(input_dataset, optimizations, output_types, output_shapes):
  return optimize_dataset(input_dataset=input_dataset, optimizations=optimizations, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OptionalFromValue(components):
  return optional_from_value(components=components)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OptionalGetValue(optional, output_types, output_shapes):
  return optional_get_value(optional=optional, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OptionalHasValue(optional):
  return optional_has_value(optional=optional)
...
def optional_none(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "OptionalNone", name, _ctx._post_execution_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PaddedBatchDataset(input_dataset, batch_size, padded_shapes, padding_values, output_shapes):
  return padded_batch_dataset(input_dataset=input_dataset, batch_size=batch_size, padded_shapes=padded_shapes, padding_values=padding_values, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PaddedBatchDatasetV2(input_dataset, batch_size, padded_shapes, padding_values, drop_remainder, output_shapes):
  return padded_batch_dataset_v2(input_dataset=input_dataset, batch_size=batch_size, padded_shapes=padded_shapes, padding_values=padding_values, drop_remainder=drop_remainder, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ParallelInterleaveDatasetV2(input_dataset, other_arguments, cycle_length, block_length, num_parallel_calls, f, output_types, output_shapes, sloppy):
  return parallel_interleave_dataset_v2(input_dataset=input_dataset, other_arguments=other_arguments, cycle_length=cycle_length, block_length=block_length, num_parallel_calls=num_parallel_calls, f=f, output_types=output_types, output_shapes=output_shapes, sloppy=sloppy)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ParallelMapDataset(input_dataset, other_arguments, num_parallel_calls, f, output_types, output_shapes, use_inter_op_parallelism, sloppy, preserve_cardinality):
  return parallel_map_dataset(input_dataset=input_dataset, other_arguments=other_arguments, num_parallel_calls=num_parallel_calls, f=f, output_types=output_types, output_shapes=output_shapes, use_inter_op_parallelism=use_inter_op_parallelism, sloppy=sloppy, preserve_cardinality=preserve_cardinality)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PrefetchDataset(input_dataset, buffer_size, output_types, output_shapes):
  return prefetch_dataset(input_dataset=input_dataset, buffer_size=buffer_size, output_types=output_types, output_shapes=output_shapes)
...
def range_dataset(start, stop, step, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "RangeDataset", name, _ctx._post_execution_callbacks, start, stop,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RangeDataset(start, stop, step, output_types, output_shapes):
  return range_dataset(start=start, stop=stop, step=step, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReduceDataset(input_dataset, initial_state, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism):
  return reduce_dataset(input_dataset=input_dataset, initial_state=initial_state, other_arguments=other_arguments, f=f, output_types=output_types, output_shapes=output_shapes, use_inter_op_parallelism=use_inter_op_parallelism)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RepeatDataset(input_dataset, count, output_types, output_shapes):
  return repeat_dataset(input_dataset=input_dataset, count=count, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SerializeIterator(resource_handle):
  return serialize_iterator(resource_handle=resource_handle)
...
def shard_dataset(input_dataset, num_shards, index, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ShardDataset", name, _ctx._post_execution_callbacks, input_dataset,
        num_shards, index, "output_types", output_types, "output_shapes",
        output_shapes)
      return _result
    except _core._FallbackException:
      try:
        return shard_dataset_eager_fallback(
            input_dataset, num_shards, index, output_types=output_types,
            output_shapes=output_shapes, name=name, ctx=_ctx)
      except _core._SymbolicException:
        pass  # Add nodes to the TensorFlow graph.
    except _core._NotOkStatusException as e:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ShardDataset(input_dataset, num_shards, index, output_types, output_shapes):
  return shard_dataset(input_dataset=input_dataset, num_shards=num_shards, index=index, output_types=output_types, output_shapes=output_shapes)
tf_export("raw_ops.ShardDataset")(ShardDataset)


def shard_dataset_eager_fallback(input_dataset, num_shards, index, output_types, output_shapes, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ShuffleAndRepeatDataset(input_dataset, buffer_size, seed, seed2, count, output_types, output_shapes):
  return shuffle_and_repeat_dataset(input_dataset=input_dataset, buffer_size=buffer_size, seed=seed, seed2=seed2, count=count, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ShuffleDataset(input_dataset, buffer_size, seed, seed2, reshuffle_each_iteration, output_types, output_shapes):
  return shuffle_dataset(input_dataset=input_dataset, buffer_size=buffer_size, seed=seed, seed2=seed2, reshuffle_each_iteration=reshuffle_each_iteration, output_types=output_types, output_shapes=output_shapes)
...
def skip_dataset(input_dataset, count, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SkipDataset", name, _ctx._post_execution_callbacks, input_dataset,
        count, "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SkipDataset(input_dataset, count, output_types, output_shapes):
  return skip_dataset(input_dataset=input_dataset, count=count, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseTensorSliceDataset(indices, values, dense_shape):
  return sparse_tensor_slice_dataset(indices=indices, values=values, dense_shape=dense_shape)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TFRecordDataset(filenames, compression_type, buffer_size):
  return tf_record_dataset(filenames=filenames, compression_type=compression_type, buffer_size=buffer_size)
...
def take_dataset(input_dataset, count, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TakeDataset", name, _ctx._post_execution_callbacks, input_dataset,
        count, "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TakeDataset(input_dataset, count, output_types, output_shapes):
  return take_dataset(input_dataset=input_dataset, count=count, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorDataset(components, output_shapes):
  return tensor_dataset(components=components, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorSliceDataset(components, output_shapes):
  return tensor_slice_dataset(components=components, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TextLineDataset(filenames, compression_type, buffer_size):
  return text_line_dataset(filenames=filenames, compression_type=compression_type, buffer_size=buffer_size)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UnwrapDatasetVariant(input_handle):
  return unwrap_dataset_variant(input_handle=input_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def WindowDataset(input_dataset, size, shift, stride, drop_remainder, output_types, output_shapes):
  return window_dataset(input_dataset=input_dataset, size=size, shift=shift, stride=stride, drop_remainder=drop_remainder, output_types=output_types, output_shapes=output_shapes)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def WrapDatasetVariant(input_handle):
  return wrap_dataset_variant(input_handle=input_handle)
...
def zip_dataset(input_datasets, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ZipDataset", name, _ctx._post_execution_callbacks, input_datasets,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ZipDataset(input_datasets, output_types, output_shapes):
  return zip_dataset(input_datasets=input_datasets, output_types=output_types, output_shapes=output_shapes)
