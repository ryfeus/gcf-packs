...
@_kwarg_only
def Multinomial(logits, num_samples, seed, seed2, output_dtype):
  return multinomial(logits=logits, num_samples=num_samples, seed=seed, seed2=seed2, output_dtype=output_dtype)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ParameterizedTruncatedNormal(shape, means, stdevs, minvals, maxvals, seed, seed2):
  return parameterized_truncated_normal(shape=shape, means=means, stdevs=stdevs, minvals=minvals, maxvals=maxvals, seed=seed, seed2=seed2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomGamma(shape, alpha, seed, seed2):
  return random_gamma(shape=shape, alpha=alpha, seed=seed, seed2=seed2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomGammaGrad(alpha, sample):
  return random_gamma_grad(alpha=alpha, sample=sample)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomPoisson(shape, rate, seed, seed2):
  return random_poisson(shape=shape, rate=rate, seed=seed, seed2=seed2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomPoissonV2(shape, rate, seed, seed2, dtype):
  return random_poisson_v2(shape=shape, rate=rate, seed=seed, seed2=seed2, dtype=dtype)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomShuffle(value, seed, seed2):
  return random_shuffle(value=value, seed=seed, seed2=seed2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomStandardNormal(shape, seed, seed2, dtype):
  return random_standard_normal(shape=shape, seed=seed, seed2=seed2, dtype=dtype)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomUniform(shape, seed, seed2, dtype):
  return random_uniform(shape=shape, seed=seed, seed2=seed2, dtype=dtype)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RandomUniformInt(shape, minval, maxval, seed, seed2):
  return random_uniform_int(shape=shape, minval=minval, maxval=maxval, seed=seed, seed2=seed2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TruncatedNormal(shape, seed, seed2, dtype):
  return truncated_normal(shape=shape, seed=seed, seed2=seed2, dtype=dtype)
