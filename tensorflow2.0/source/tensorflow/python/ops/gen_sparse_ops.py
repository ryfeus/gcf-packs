...
@_kwarg_only
def AddManySparseToTensorsMap(sparse_indices, sparse_values, sparse_shape, container, shared_name):
  return add_many_sparse_to_tensors_map(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, container=container, shared_name=shared_name)
tf_export("raw_ops.AddManySparseToTensorsMap")(AddManySparseToTensorsMap)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AddSparseToTensorsMap(sparse_indices, sparse_values, sparse_shape, container, shared_name):
  return add_sparse_to_tensors_map(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, container=container, shared_name=shared_name)
tf_export("raw_ops.AddSparseToTensorsMap")(AddSparseToTensorsMap)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DeserializeManySparse(serialized_sparse, dtype):
  return deserialize_many_sparse(serialized_sparse=serialized_sparse, dtype=dtype)
tf_export("raw_ops.DeserializeManySparse")(DeserializeManySparse)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DeserializeSparse(serialized_sparse, dtype):
  return deserialize_sparse(serialized_sparse=serialized_sparse, dtype=dtype)
tf_export("raw_ops.DeserializeSparse")(DeserializeSparse)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SerializeManySparse(sparse_indices, sparse_values, sparse_shape, out_type):
  return serialize_many_sparse(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, out_type=out_type)
tf_export("raw_ops.SerializeManySparse")(SerializeManySparse)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SerializeSparse(sparse_indices, sparse_values, sparse_shape, out_type):
  return serialize_sparse(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, out_type=out_type)
tf_export("raw_ops.SerializeSparse")(SerializeSparse)
...
def sparse_add(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SparseAdd", name, _ctx._post_execution_callbacks, a_indices,
        a_values, a_shape, b_indices, b_values, b_shape, thresh)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseAdd(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh):
  return sparse_add(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b_indices=b_indices, b_values=b_values, b_shape=b_shape, thresh=thresh)
tf_export("raw_ops.SparseAdd")(SparseAdd)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseAddGrad(backprop_val_grad, a_indices, b_indices, sum_indices):
  return sparse_add_grad(backprop_val_grad=backprop_val_grad, a_indices=a_indices, b_indices=b_indices, sum_indices=sum_indices)
tf_export("raw_ops.SparseAddGrad")(SparseAddGrad)
...
def sparse_concat(indices, values, shapes, concat_dim, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SparseConcat", name, _ctx._post_execution_callbacks, indices, values,
        shapes, "concat_dim", concat_dim)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseConcat(indices, values, shapes, concat_dim):
  return sparse_concat(indices=indices, values=values, shapes=shapes, concat_dim=concat_dim)
tf_export("raw_ops.SparseConcat")(SparseConcat)
...
def sparse_cross(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SparseCross", name, _ctx._post_execution_callbacks, indices, values,
        shapes, dense_inputs, "hashed_output", hashed_output, "num_buckets",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseCross(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type):
  return sparse_cross(indices=indices, values=values, shapes=shapes, dense_inputs=dense_inputs, hashed_output=hashed_output, num_buckets=num_buckets, hash_key=hash_key, out_type=out_type, internal_type=internal_type)
tf_export("raw_ops.SparseCross")(SparseCross)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseDenseCwiseAdd(sp_indices, sp_values, sp_shape, dense):
  return sparse_dense_cwise_add(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape, dense=dense)
tf_export("raw_ops.SparseDenseCwiseAdd")(SparseDenseCwiseAdd)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseDenseCwiseDiv(sp_indices, sp_values, sp_shape, dense):
  return sparse_dense_cwise_div(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape, dense=dense)
tf_export("raw_ops.SparseDenseCwiseDiv")(SparseDenseCwiseDiv)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseDenseCwiseMul(sp_indices, sp_values, sp_shape, dense):
  return sparse_dense_cwise_mul(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape, dense=dense)
tf_export("raw_ops.SparseDenseCwiseMul")(SparseDenseCwiseMul)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseFillEmptyRows(indices, values, dense_shape, default_value):
  return sparse_fill_empty_rows(indices=indices, values=values, dense_shape=dense_shape, default_value=default_value)
tf_export("raw_ops.SparseFillEmptyRows")(SparseFillEmptyRows)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseFillEmptyRowsGrad(reverse_index_map, grad_values):
  return sparse_fill_empty_rows_grad(reverse_index_map=reverse_index_map, grad_values=grad_values)
tf_export("raw_ops.SparseFillEmptyRowsGrad")(SparseFillEmptyRowsGrad)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseReduceMax(input_indices, input_values, input_shape, reduction_axes, keep_dims):
  return sparse_reduce_max(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims)
tf_export("raw_ops.SparseReduceMax")(SparseReduceMax)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseReduceMaxSparse(input_indices, input_values, input_shape, reduction_axes, keep_dims):
  return sparse_reduce_max_sparse(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims)
tf_export("raw_ops.SparseReduceMaxSparse")(SparseReduceMaxSparse)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseReduceSum(input_indices, input_values, input_shape, reduction_axes, keep_dims):
  return sparse_reduce_sum(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims)
tf_export("raw_ops.SparseReduceSum")(SparseReduceSum)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseReduceSumSparse(input_indices, input_values, input_shape, reduction_axes, keep_dims):
  return sparse_reduce_sum_sparse(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims)
tf_export("raw_ops.SparseReduceSumSparse")(SparseReduceSumSparse)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseReorder(input_indices, input_values, input_shape):
  return sparse_reorder(input_indices=input_indices, input_values=input_values, input_shape=input_shape)
tf_export("raw_ops.SparseReorder")(SparseReorder)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseReshape(input_indices, input_shape, new_shape):
  return sparse_reshape(input_indices=input_indices, input_shape=input_shape, new_shape=new_shape)
tf_export("raw_ops.SparseReshape")(SparseReshape)
...
def sparse_slice(indices, values, shape, start, size, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SparseSlice", name, _ctx._post_execution_callbacks, indices, values,
        shape, start, size)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSlice(indices, values, shape, start, size):
  return sparse_slice(indices=indices, values=values, shape=shape, start=start, size=size)
tf_export("raw_ops.SparseSlice")(SparseSlice)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSliceGrad(backprop_val_grad, input_indices, input_start, output_indices):
  return sparse_slice_grad(backprop_val_grad=backprop_val_grad, input_indices=input_indices, input_start=input_start, output_indices=output_indices)
tf_export("raw_ops.SparseSliceGrad")(SparseSliceGrad)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSoftmax(sp_indices, sp_values, sp_shape):
  return sparse_softmax(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape)
tf_export("raw_ops.SparseSoftmax")(SparseSoftmax)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSparseMaximum(a_indices, a_values, a_shape, b_indices, b_values, b_shape):
  return sparse_sparse_maximum(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b_indices=b_indices, b_values=b_values, b_shape=b_shape)
tf_export("raw_ops.SparseSparseMaximum")(SparseSparseMaximum)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSparseMinimum(a_indices, a_values, a_shape, b_indices, b_values, b_shape):
  return sparse_sparse_minimum(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b_indices=b_indices, b_values=b_values, b_shape=b_shape)
tf_export("raw_ops.SparseSparseMinimum")(SparseSparseMinimum)
...
def sparse_split(split_dim, indices, values, shape, num_split, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SparseSplit", name, _ctx._post_execution_callbacks, split_dim,
        indices, values, shape, "num_split", num_split)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSplit(split_dim, indices, values, shape, num_split):
  return sparse_split(split_dim=split_dim, indices=indices, values=values, shape=shape, num_split=num_split)
tf_export("raw_ops.SparseSplit")(SparseSplit)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseTensorDenseAdd(a_indices, a_values, a_shape, b):
  return sparse_tensor_dense_add(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b=b)
tf_export("raw_ops.SparseTensorDenseAdd")(SparseTensorDenseAdd)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseTensorDenseMatMul(a_indices, a_values, a_shape, b, adjoint_a, adjoint_b):
  return sparse_tensor_dense_mat_mul(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b=b, adjoint_a=adjoint_a, adjoint_b=adjoint_b)
tf_export("raw_ops.SparseTensorDenseMatMul")(SparseTensorDenseMatMul)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseToDense(sparse_indices, output_shape, sparse_values, default_value, validate_indices):
  return sparse_to_dense(sparse_indices=sparse_indices, output_shape=output_shape, sparse_values=sparse_values, default_value=default_value, validate_indices=validate_indices)
tf_export("raw_ops.SparseToDense")(SparseToDense)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TakeManySparseFromTensorsMap(sparse_handles, dtype, container, shared_name):
  return take_many_sparse_from_tensors_map(sparse_handles=sparse_handles, dtype=dtype, container=container, shared_name=shared_name)
tf_export("raw_ops.TakeManySparseFromTensorsMap")(TakeManySparseFromTensorsMap)
