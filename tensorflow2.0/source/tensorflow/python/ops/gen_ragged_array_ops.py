  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "RaggedGather", name, _ctx._post_execution_callbacks,
...
@_kwarg_only
def RaggedGather(params_nested_splits, params_dense_values, indices, OUTPUT_RAGGED_RANK):
  return ragged_gather(params_nested_splits=params_nested_splits, params_dense_values=params_dense_values, indices=indices, OUTPUT_RAGGED_RANK=OUTPUT_RAGGED_RANK)
