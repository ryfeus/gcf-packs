  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "DecodeCSV", name, _ctx._post_execution_callbacks, records,
        record_defaults, "field_delim", field_delim, "use_quote_delim",
        use_quote_delim, "na_value", na_value, "select_cols", select_cols)
      return _result
...
@_kwarg_only
def DecodeCSV(records, record_defaults, field_delim, use_quote_delim, na_value, select_cols):
  return decode_csv(records=records, record_defaults=record_defaults, field_delim=field_delim, use_quote_delim=use_quote_delim, na_value=na_value, select_cols=select_cols)
tf_export("raw_ops.DecodeCSV")(DecodeCSV)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DecodeCompressed(bytes, compression_type):
  return decode_compressed(bytes=bytes, compression_type=compression_type)
tf_export("raw_ops.DecodeCompressed")(DecodeCompressed)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DecodeJSONExample(json_examples):
  return decode_json_example(json_examples=json_examples)
tf_export("raw_ops.DecodeJSONExample")(DecodeJSONExample)
...
def decode_raw(bytes, out_type, little_endian=True, name=None):
  ...
  Args:
    ...
    out_type: A `tf.DType` from: `tf.half, tf.float32, tf.float64, tf.int32, tf.uint16, tf.uint8, tf.int16, tf.int8, tf.int64, tf.complex64, tf.complex128`.
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DecodeRaw", name, _ctx._post_execution_callbacks, bytes, "out_type",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DecodeRaw(bytes, out_type, little_endian):
  return decode_raw(bytes=bytes, out_type=out_type, little_endian=little_endian)
tf_export("raw_ops.DecodeRaw")(DecodeRaw)
...
def parse_example(serialized, names, sparse_keys, dense_keys, dense_defaults, sparse_types, dense_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ParseExample", name, _ctx._post_execution_callbacks, serialized,
        names, sparse_keys, dense_keys, dense_defaults, "sparse_types",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ParseExample(serialized, names, sparse_keys, dense_keys, dense_defaults, sparse_types, dense_shapes):
  return parse_example(serialized=serialized, names=names, sparse_keys=sparse_keys, dense_keys=dense_keys, dense_defaults=dense_defaults, sparse_types=sparse_types, dense_shapes=dense_shapes)
tf_export("raw_ops.ParseExample")(ParseExample)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ParseSingleExample(serialized, dense_defaults, num_sparse, sparse_keys, dense_keys, sparse_types, dense_shapes):
  return parse_single_example(serialized=serialized, dense_defaults=dense_defaults, num_sparse=num_sparse, sparse_keys=sparse_keys, dense_keys=dense_keys, sparse_types=sparse_types, dense_shapes=dense_shapes)
tf_export("raw_ops.ParseSingleExample")(ParseSingleExample)
...
def parse_tensor(serialized, out_type, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ParseTensor", name, _ctx._post_execution_callbacks, serialized,
        "out_type", out_type)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ParseTensor(serialized, out_type):
  return parse_tensor(serialized=serialized, out_type=out_type)
tf_export("raw_ops.ParseTensor")(ParseTensor)
...
def SerializeTensor(tensor):
  return serialize_tensor(tensor=tensor)
tf_export("raw_ops.SerializeTensor")(SerializeTensor)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StringToNumber(string_tensor, out_type):
  return string_to_number(string_tensor=string_tensor, out_type=out_type)
tf_export("raw_ops.StringToNumber")(StringToNumber)
