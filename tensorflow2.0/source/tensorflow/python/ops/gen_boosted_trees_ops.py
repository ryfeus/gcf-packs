...
@_kwarg_only
def BoostedTreesBucketize(float_values, bucket_boundaries):
  return boosted_trees_bucketize(float_values=float_values, bucket_boundaries=bucket_boundaries)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesCalculateBestGainsPerFeature(node_id_range, stats_summary_list, l1, l2, tree_complexity, min_node_weight, max_splits):
  return boosted_trees_calculate_best_gains_per_feature(node_id_range=node_id_range, stats_summary_list=stats_summary_list, l1=l1, l2=l2, tree_complexity=tree_complexity, min_node_weight=min_node_weight, max_splits=max_splits)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesCenterBias(tree_ensemble_handle, mean_gradients, mean_hessians, l1, l2):
  return boosted_trees_center_bias(tree_ensemble_handle=tree_ensemble_handle, mean_gradients=mean_gradients, mean_hessians=mean_hessians, l1=l1, l2=l2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesCreateEnsemble(tree_ensemble_handle, stamp_token, tree_ensemble_serialized):
  return boosted_trees_create_ensemble(tree_ensemble_handle=tree_ensemble_handle, stamp_token=stamp_token, tree_ensemble_serialized=tree_ensemble_serialized)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesCreateQuantileStreamResource(quantile_stream_resource_handle, epsilon, num_streams, max_elements):
  return boosted_trees_create_quantile_stream_resource(quantile_stream_resource_handle=quantile_stream_resource_handle, epsilon=epsilon, num_streams=num_streams, max_elements=max_elements)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesDeserializeEnsemble(tree_ensemble_handle, stamp_token, tree_ensemble_serialized):
  return boosted_trees_deserialize_ensemble(tree_ensemble_handle=tree_ensemble_handle, stamp_token=stamp_token, tree_ensemble_serialized=tree_ensemble_serialized)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesEnsembleResourceHandleOp(container, shared_name):
  return boosted_trees_ensemble_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesExampleDebugOutputs(tree_ensemble_handle, bucketized_features, logits_dimension):
  return boosted_trees_example_debug_outputs(tree_ensemble_handle=tree_ensemble_handle, bucketized_features=bucketized_features, logits_dimension=logits_dimension)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesGetEnsembleStates(tree_ensemble_handle):
  return boosted_trees_get_ensemble_states(tree_ensemble_handle=tree_ensemble_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesMakeQuantileSummaries(float_values, example_weights, epsilon):
  return boosted_trees_make_quantile_summaries(float_values=float_values, example_weights=example_weights, epsilon=epsilon)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesMakeStatsSummary(node_ids, gradients, hessians, bucketized_features_list, max_splits, num_buckets):
  return boosted_trees_make_stats_summary(node_ids=node_ids, gradients=gradients, hessians=hessians, bucketized_features_list=bucketized_features_list, max_splits=max_splits, num_buckets=num_buckets)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesPredict(tree_ensemble_handle, bucketized_features, logits_dimension):
  return boosted_trees_predict(tree_ensemble_handle=tree_ensemble_handle, bucketized_features=bucketized_features, logits_dimension=logits_dimension)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesQuantileStreamResourceAddSummaries(quantile_stream_resource_handle, summaries):
  return boosted_trees_quantile_stream_resource_add_summaries(quantile_stream_resource_handle=quantile_stream_resource_handle, summaries=summaries)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesQuantileStreamResourceDeserialize(quantile_stream_resource_handle, bucket_boundaries):
  return boosted_trees_quantile_stream_resource_deserialize(quantile_stream_resource_handle=quantile_stream_resource_handle, bucket_boundaries=bucket_boundaries)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesQuantileStreamResourceFlush(quantile_stream_resource_handle, num_buckets, generate_quantiles):
  return boosted_trees_quantile_stream_resource_flush(quantile_stream_resource_handle=quantile_stream_resource_handle, num_buckets=num_buckets, generate_quantiles=generate_quantiles)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesQuantileStreamResourceGetBucketBoundaries(quantile_stream_resource_handle, num_features):
  return boosted_trees_quantile_stream_resource_get_bucket_boundaries(quantile_stream_resource_handle=quantile_stream_resource_handle, num_features=num_features)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesQuantileStreamResourceHandleOp(container, shared_name):
  return boosted_trees_quantile_stream_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesSerializeEnsemble(tree_ensemble_handle):
  return boosted_trees_serialize_ensemble(tree_ensemble_handle=tree_ensemble_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesTrainingPredict(tree_ensemble_handle, cached_tree_ids, cached_node_ids, bucketized_features, logits_dimension):
  return boosted_trees_training_predict(tree_ensemble_handle=tree_ensemble_handle, cached_tree_ids=cached_tree_ids, cached_node_ids=cached_node_ids, bucketized_features=bucketized_features, logits_dimension=logits_dimension)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BoostedTreesUpdateEnsemble(tree_ensemble_handle, feature_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, max_depth, learning_rate, pruning_mode):
  return boosted_trees_update_ensemble(tree_ensemble_handle=tree_ensemble_handle, feature_ids=feature_ids, node_ids=node_ids, gains=gains, thresholds=thresholds, left_node_contribs=left_node_contribs, right_node_contribs=right_node_contribs, max_depth=max_depth, learning_rate=learning_rate, pruning_mode=pruning_mode)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IsBoostedTreesEnsembleInitialized(tree_ensemble_handle):
  return is_boosted_trees_ensemble_initialized(tree_ensemble_handle=tree_ensemble_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IsBoostedTreesQuantileStreamResourceInitialized(quantile_stream_resource_handle):
  return is_boosted_trees_quantile_stream_resource_initialized(quantile_stream_resource_handle=quantile_stream_resource_handle)
