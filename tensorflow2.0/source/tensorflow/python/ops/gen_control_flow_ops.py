...
@_kwarg_only
def Abort(error_msg, exit_without_error):
  return abort(error_msg=error_msg, exit_without_error=exit_without_error)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Enter(data, frame_name, is_constant, parallel_iterations):
  return enter(data=data, frame_name=frame_name, is_constant=is_constant, parallel_iterations=parallel_iterations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NextIteration(data):
  return next_iteration(data=data)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefEnter(data, frame_name, is_constant, parallel_iterations):
  return ref_enter(data=data, frame_name=frame_name, is_constant=is_constant, parallel_iterations=parallel_iterations)
...
@_kwarg_only
def RefMerge(inputs):
  return ref_merge(inputs=inputs)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefNextIteration(data):
  return ref_next_iteration(data=data)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefSelect(index, inputs):
  return ref_select(index=index, inputs=inputs)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefSwitch(data, pred):
  return ref_switch(data=data, pred=pred)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Switch(data, pred):
  return switch(data=data, pred=pred)
