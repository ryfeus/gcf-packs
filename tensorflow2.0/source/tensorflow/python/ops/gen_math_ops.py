...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AccumulateNV2(inputs, shape):
  return accumulate_nv2(inputs=inputs, shape=shape)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, input, axis, "keep_dims",
        keep_dims)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def All(input, reduction_indices, keep_dims):
  return _all(input=input, axis=reduction_indices, keep_dims=keep_dims)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, input, "Tout", Tout)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Angle(input, Tout):
  return angle(input=input, Tout=Tout)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Any(input, reduction_indices, keep_dims):
  return _any(input=input, axis=reduction_indices, keep_dims=keep_dims)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApproximateEqual(x, y, tolerance):
  return approximate_equal(x=x, y=y, tolerance=tolerance)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, input, dimension, "output_type",
        output_type)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ArgMax(input, dimension, output_type):
  return arg_max(input=input, dimension=dimension, output_type=output_type)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ArgMin(input, dimension, output_type):
  return arg_min(input=input, dimension=dimension, output_type=output_type)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, y, x)
      return _result
    except _core._FallbackException:
      try:
...
def batch_mat_mul(x, y, adj_x=False, adj_y=False, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "BatchMatMul", name, _ctx._post_execution_callbacks, x, y, "adj_x",
        adj_x, "adj_y", adj_y)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchMatMul(x, y, adj_x, adj_y):
  return batch_mat_mul(x=x, y=y, adj_x=adj_x, adj_y=adj_y)
...
def bessel_i0e(x, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "BesselI0e", name, _ctx._post_execution_callbacks, x)
      return _result
    except _core._FallbackException:
      try:
...
def bessel_i1e(x, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "BesselI1e", name, _ctx._post_execution_callbacks, x)
      return _result
    except _core._FallbackException:
      try:
...
def Bincount(arr, size, weights):
  return bincount(arr=arr, size=size, weights=weights)
...
def bucketize(input, boundaries, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Bucketize", name, _ctx._post_execution_callbacks, input,
...
def Bucketize(input, boundaries):
  return bucketize(input=input, boundaries=boundaries)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, x, "DstT", DstT, "Truncate",
        Truncate)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Cast(x, DstT, Truncate):
  return cast(x=x, DstT=DstT, Truncate=Truncate)
...
def _clip_by_value(t, clip_value_min, clip_value_max, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ClipByValue", name, _ctx._post_execution_callbacks, t,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ClipByValue(t, clip_value_min, clip_value_max):
  return _clip_by_value(t=t, clip_value_min=clip_value_min, clip_value_max=clip_value_max)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CompareAndBitpack(input, threshold):
  return compare_and_bitpack(input=input, threshold=threshold)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Complex(real, imag, Tout):
  return _complex(real=real, imag=imag, Tout=Tout)
...
def complex_abs(x, Tout=_dtypes.float32, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ComplexAbs", name, _ctx._post_execution_callbacks, x, "Tout", Tout)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ComplexAbs(x, Tout):
  return complex_abs(x=x, Tout=Tout)
...
def Cumprod(x, axis, exclusive, reverse):
  return cumprod(x=x, axis=axis, exclusive=exclusive, reverse=reverse)
...
def Cumsum(x, axis, exclusive, reverse):
  return cumsum(x=x, axis=axis, exclusive=exclusive, reverse=reverse)
...
def euclidean_norm(input, axis, keep_dims=False, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "EuclideanNorm", name, _ctx._post_execution_callbacks, input, axis,
        "keep_dims", keep_dims)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def EuclideanNorm(input, reduction_indices, keep_dims):
  return euclidean_norm(input=input, axis=reduction_indices, keep_dims=keep_dims)
  ...
  *NOTE*: `math.greater_equal` supports broadcasting. More about broadcasting
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "GreaterEqual", name, _ctx._post_execution_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def HistogramFixedWidth(values, value_range, nbins, dtype):
  return _histogram_fixed_width(values=values, value_range=value_range, nbins=nbins, dtype=dtype)
...
def igamma_grad_a(a, x, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "IgammaGradA", name, _ctx._post_execution_callbacks, a, x)
      return _result
    except _core._FallbackException:
      try:
...
@_kwarg_only
def Imag(input, Tout):
  return imag(input=input, Tout=Tout)
  ...
  *NOTE*: `math.less_equal` supports broadcasting. More about broadcasting
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "LessEqual", name, _ctx._post_execution_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
...
def LinSpace(start, stop, num):
  return lin_space(start=start, stop=stop, num=num)
  ...
  *NOTE*: `math.logical_and` supports broadcasting. More about broadcasting
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "LogicalAnd", name, _ctx._post_execution_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
...
def logical_not(x, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "LogicalNot", name, _ctx._post_execution_callbacks, x)
      return _result
    except _core._FallbackException:
      try:
  ...
  *NOTE*: `math.logical_or` supports broadcasting. More about broadcasting
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "LogicalOr", name, _ctx._post_execution_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        transpose_a, "transpose_b", transpose_b)
      return _result
    except _core._FallbackException:
      try:
...
def MatMul(a, b, transpose_a, transpose_b):
  return mat_mul(a=a, b=b, transpose_a=transpose_a, transpose_b=transpose_b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Max(input, reduction_indices, keep_dims):
  return _max(input=input, axis=reduction_indices, keep_dims=keep_dims)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Mean(input, reduction_indices, keep_dims):
  return mean(input=input, axis=reduction_indices, keep_dims=keep_dims)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Min(input, reduction_indices, keep_dims):
  return _min(input=input, axis=reduction_indices, keep_dims=keep_dims)
...
def next_after(x1, x2, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "NextAfter", name, _ctx._post_execution_callbacks, x1, x2)
      return _result
    except _core._FallbackException:
      try:
...
def polygamma(a, x, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Polygamma", name, _ctx._post_execution_callbacks, a, x)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Prod(input, reduction_indices, keep_dims):
  return prod(input=input, axis=reduction_indices, keep_dims=keep_dims)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizeDownAndShrinkRange(input, input_min, input_max, out_type):
  return quantize_down_and_shrink_range(input=input, input_min=input_min, input_max=input_max, out_type=out_type)
...
def quantized_add(x, y, min_x, max_x, min_y, max_y, Toutput=_dtypes.qint32, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedAdd", name, _ctx._post_execution_callbacks, x, y, min_x,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedAdd(x, y, min_x, max_x, min_y, max_y, Toutput):
  return quantized_add(x=x, y=y, min_x=min_x, max_x=max_x, min_y=min_y, max_y=max_y, Toutput=Toutput)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedMatMul(a, b, min_a, max_a, min_b, max_b, Toutput, transpose_a, transpose_b, Tactivation):
  return quantized_mat_mul(a=a, b=b, min_a=min_a, max_a=max_a, min_b=min_b, max_b=max_b, Toutput=Toutput, transpose_a=transpose_a, transpose_b=transpose_b, Tactivation=Tactivation)
...
def quantized_mul(x, y, min_x, max_x, min_y, max_y, Toutput=_dtypes.qint32, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedMul", name, _ctx._post_execution_callbacks, x, y, min_x,
        max_x, min_y, max_y, "Toutput", Toutput)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedMul(x, y, min_x, max_x, min_y, max_y, Toutput):
  return quantized_mul(x=x, y=y, min_x=min_x, max_x=max_x, min_y=min_y, max_y=max_y, Toutput=Toutput)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, start, limit, delta)
      return _result
    except _core._FallbackException:
      try:
...
def Range(start, limit, delta):
  return _range(start=start, limit=limit, delta=delta)
...
@_kwarg_only
def Real(input, Tout):
  return real(input=input, Tout=Tout)
...
def reciprocal(x, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Reciprocal", name, _ctx._post_execution_callbacks, x)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReciprocalGrad(y, dy):
  return reciprocal_grad(y=y, dy=dy)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RequantizationRange(input, input_min, input_max):
  return requantization_range(input=input, input_min=input_min, input_max=input_max)
...
def requantization_range_per_channel(input, input_min, input_max, clip_value_max, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "RequantizationRangePerChannel", name, _ctx._post_execution_callbacks,
  ...
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
  _attrs = ("T", _op.get_attr("T"), "clip_value_max",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RequantizationRangePerChannel(input, input_min, input_max, clip_value_max):
  return requantization_range_per_channel(input=input, input_min=input_min, input_max=input_max, clip_value_max=clip_value_max)
...
def requantize(input, input_min, input_max, requested_output_min, requested_output_max, out_type, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Requantize", name, _ctx._post_execution_callbacks, input, input_min,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Requantize(input, input_min, input_max, requested_output_min, requested_output_max, out_type):
  return requantize(input=input, input_min=input_min, input_max=input_max, requested_output_min=requested_output_min, requested_output_max=requested_output_max, out_type=out_type)
...
def requantize_per_channel(input, input_min, input_max, requested_output_min, requested_output_max, out_type=_dtypes.quint8, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "RequantizePerChannel", name, _ctx._post_execution_callbacks, input,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RequantizePerChannel(input, input_min, input_max, requested_output_min, requested_output_max, out_type):
  return requantize_per_channel(input=input, input_min=input_min, input_max=input_max, requested_output_min=requested_output_min, requested_output_max=requested_output_max, out_type=out_type)
...
def rsqrt_grad(y, dy, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "RsqrtGrad", name, _ctx._post_execution_callbacks, y, dy)
      return _result
    except _core._FallbackException:
      try:
...
def segment_max(data, segment_ids, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SegmentMax", name, _ctx._post_execution_callbacks, data, segment_ids)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SegmentMax(data, segment_ids):
  return segment_max(data=data, segment_ids=segment_ids)
...
def segment_mean(data, segment_ids, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SegmentMean", name, _ctx._post_execution_callbacks, data,
        segment_ids)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SegmentMean(data, segment_ids):
  return segment_mean(data=data, segment_ids=segment_ids)
...
def segment_min(data, segment_ids, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SegmentMin", name, _ctx._post_execution_callbacks, data, segment_ids)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SegmentMin(data, segment_ids):
  return segment_min(data=data, segment_ids=segment_ids)
...
def segment_prod(data, segment_ids, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SegmentProd", name, _ctx._post_execution_callbacks, data,
        segment_ids)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SegmentProd(data, segment_ids):
  return segment_prod(data=data, segment_ids=segment_ids)
...
def segment_sum(data, segment_ids, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SegmentSum", name, _ctx._post_execution_callbacks, data, segment_ids)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SegmentSum(data, segment_ids):
  return segment_sum(data=data, segment_ids=segment_ids)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, condition, x, y)
      return _result
    except _core._FallbackException:
      try:
...
def Select(condition, t, e):
  return select(condition=condition, x=t, y=e)
...
def sigmoid_grad(y, dy, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SigmoidGrad", name, _ctx._post_execution_callbacks, y, dy)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SigmoidGrad(y, dy):
  return sigmoid_grad(y=y, dy=dy)
...
def sparse_mat_mul(a, b, transpose_a=False, transpose_b=False, a_is_sparse=False, b_is_sparse=False, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SparseMatMul", name, _ctx._post_execution_callbacks, a, b,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseMatMul(a, b, transpose_a, transpose_b, a_is_sparse, b_is_sparse):
  return sparse_mat_mul(a=a, b=b, transpose_a=transpose_a, transpose_b=transpose_b, a_is_sparse=a_is_sparse, b_is_sparse=b_is_sparse)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentMean(data, indices, segment_ids):
  return sparse_segment_mean(data=data, indices=indices, segment_ids=segment_ids)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentMeanGrad(grad, indices, segment_ids, output_dim0):
  return sparse_segment_mean_grad(grad=grad, indices=indices, segment_ids=segment_ids, output_dim0=output_dim0)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentMeanWithNumSegments(data, indices, segment_ids, num_segments):
  return sparse_segment_mean_with_num_segments(data=data, indices=indices, segment_ids=segment_ids, num_segments=num_segments)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentSqrtN(data, indices, segment_ids):
  return sparse_segment_sqrt_n(data=data, indices=indices, segment_ids=segment_ids)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentSqrtNGrad(grad, indices, segment_ids, output_dim0):
  return sparse_segment_sqrt_n_grad(grad=grad, indices=indices, segment_ids=segment_ids, output_dim0=output_dim0)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentSqrtNWithNumSegments(data, indices, segment_ids, num_segments):
  return sparse_segment_sqrt_n_with_num_segments(data=data, indices=indices, segment_ids=segment_ids, num_segments=num_segments)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentSum(data, indices, segment_ids):
  return sparse_segment_sum(data=data, indices=indices, segment_ids=segment_ids)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSegmentSumWithNumSegments(data, indices, segment_ids, num_segments):
  return sparse_segment_sum_with_num_segments(data=data, indices=indices, segment_ids=segment_ids, num_segments=num_segments)
...
def SquaredDifference(x, y):
  return squared_difference(x=x, y=y)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Sum(input, reduction_indices, keep_dims):
  return _sum(input=input, axis=reduction_indices, keep_dims=keep_dims)
  ...
  *NOTE*: `truncatediv` supports broadcasting. More about broadcasting
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TruncateDiv", name, _ctx._post_execution_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
  ...
  *NOTE*: `truncatemod` supports broadcasting. More about broadcasting
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TruncateMod", name, _ctx._post_execution_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UnsortedSegmentMax(data, segment_ids, num_segments):
  return unsorted_segment_max(data=data, segment_ids=segment_ids, num_segments=num_segments)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UnsortedSegmentMin(data, segment_ids, num_segments):
  return unsorted_segment_min(data=data, segment_ids=segment_ids, num_segments=num_segments)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UnsortedSegmentProd(data, segment_ids, num_segments):
  return unsorted_segment_prod(data=data, segment_ids=segment_ids, num_segments=num_segments)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def UnsortedSegmentSum(data, segment_ids, num_segments):
  return unsorted_segment_sum(data=data, segment_ids=segment_ids, num_segments=num_segments)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, x, q)
      return _result
    except _core._FallbackException:
      try:
