...
@_kwarg_only
def CTCBeamSearchDecoder(inputs, sequence_length, beam_width, top_paths, merge_repeated):
  return ctc_beam_search_decoder(inputs=inputs, sequence_length=sequence_length, beam_width=beam_width, top_paths=top_paths, merge_repeated=merge_repeated)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CTCGreedyDecoder(inputs, sequence_length, merge_repeated):
  return ctc_greedy_decoder(inputs=inputs, sequence_length=sequence_length, merge_repeated=merge_repeated)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CTCLoss(inputs, labels_indices, labels_values, sequence_length, preprocess_collapse_repeated, ctc_merge_repeated, ignore_longer_outputs_than_inputs):
  return ctc_loss(inputs=inputs, labels_indices=labels_indices, labels_values=labels_values, sequence_length=sequence_length, preprocess_collapse_repeated=preprocess_collapse_repeated, ctc_merge_repeated=ctc_merge_repeated, ignore_longer_outputs_than_inputs=ignore_longer_outputs_than_inputs)
