...
@_kwarg_only
def FixedLengthRecordReader(header_bytes, record_bytes, footer_bytes, hop_bytes, container, shared_name):
  return fixed_length_record_reader(header_bytes=header_bytes, record_bytes=record_bytes, footer_bytes=footer_bytes, hop_bytes=hop_bytes, container=container, shared_name=shared_name)
tf_export("raw_ops.FixedLengthRecordReader")(FixedLengthRecordReader)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FixedLengthRecordReaderV2(header_bytes, record_bytes, footer_bytes, hop_bytes, container, shared_name, encoding):
  return fixed_length_record_reader_v2(header_bytes=header_bytes, record_bytes=record_bytes, footer_bytes=footer_bytes, hop_bytes=hop_bytes, container=container, shared_name=shared_name, encoding=encoding)
tf_export("raw_ops.FixedLengthRecordReaderV2")(FixedLengthRecordReaderV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IdentityReader(container, shared_name):
  return identity_reader(container=container, shared_name=shared_name)
tf_export("raw_ops.IdentityReader")(IdentityReader)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IdentityReaderV2(container, shared_name):
  return identity_reader_v2(container=container, shared_name=shared_name)
tf_export("raw_ops.IdentityReaderV2")(IdentityReaderV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LMDBReader(container, shared_name):
  return lmdb_reader(container=container, shared_name=shared_name)
tf_export("raw_ops.LMDBReader")(LMDBReader)
...
def MatchingFiles(pattern):
  return matching_files(pattern=pattern)
tf_export("raw_ops.MatchingFiles")(MatchingFiles)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MergeV2Checkpoints(checkpoint_prefixes, destination_prefix, delete_old_dirs):
  return merge_v2_checkpoints(checkpoint_prefixes=checkpoint_prefixes, destination_prefix=destination_prefix, delete_old_dirs=delete_old_dirs)
tf_export("raw_ops.MergeV2Checkpoints")(MergeV2Checkpoints)
...
def read_file(filename, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "ReadFile",
...
tf_export("raw_ops.ReadFile")(ReadFile)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderNumRecordsProduced(reader_handle):
  return reader_num_records_produced(reader_handle=reader_handle)
tf_export("raw_ops.ReaderNumRecordsProduced")(ReaderNumRecordsProduced)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderNumRecordsProducedV2(reader_handle):
  return reader_num_records_produced_v2(reader_handle=reader_handle)
tf_export("raw_ops.ReaderNumRecordsProducedV2")(ReaderNumRecordsProducedV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderNumWorkUnitsCompleted(reader_handle):
  return reader_num_work_units_completed(reader_handle=reader_handle)
tf_export("raw_ops.ReaderNumWorkUnitsCompleted")(ReaderNumWorkUnitsCompleted)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderNumWorkUnitsCompletedV2(reader_handle):
  return reader_num_work_units_completed_v2(reader_handle=reader_handle)
tf_export("raw_ops.ReaderNumWorkUnitsCompletedV2")(ReaderNumWorkUnitsCompletedV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderRead(reader_handle, queue_handle):
  return reader_read(reader_handle=reader_handle, queue_handle=queue_handle)
tf_export("raw_ops.ReaderRead")(ReaderRead)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderReadUpTo(reader_handle, queue_handle, num_records):
  return reader_read_up_to(reader_handle=reader_handle, queue_handle=queue_handle, num_records=num_records)
tf_export("raw_ops.ReaderReadUpTo")(ReaderReadUpTo)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderReadUpToV2(reader_handle, queue_handle, num_records):
  return reader_read_up_to_v2(reader_handle=reader_handle, queue_handle=queue_handle, num_records=num_records)
tf_export("raw_ops.ReaderReadUpToV2")(ReaderReadUpToV2)
...
def reader_read_v2(reader_handle, queue_handle, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ReaderReadV2", name, _ctx._post_execution_callbacks, reader_handle,
        queue_handle)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderReadV2(reader_handle, queue_handle):
  return reader_read_v2(reader_handle=reader_handle, queue_handle=queue_handle)
tf_export("raw_ops.ReaderReadV2")(ReaderReadV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderReset(reader_handle):
  return reader_reset(reader_handle=reader_handle)
tf_export("raw_ops.ReaderReset")(ReaderReset)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderResetV2(reader_handle):
  return reader_reset_v2(reader_handle=reader_handle)
tf_export("raw_ops.ReaderResetV2")(ReaderResetV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderRestoreState(reader_handle, state):
  return reader_restore_state(reader_handle=reader_handle, state=state)
tf_export("raw_ops.ReaderRestoreState")(ReaderRestoreState)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderRestoreStateV2(reader_handle, state):
  return reader_restore_state_v2(reader_handle=reader_handle, state=state)
tf_export("raw_ops.ReaderRestoreStateV2")(ReaderRestoreStateV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderSerializeState(reader_handle):
  return reader_serialize_state(reader_handle=reader_handle)
tf_export("raw_ops.ReaderSerializeState")(ReaderSerializeState)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReaderSerializeStateV2(reader_handle):
  return reader_serialize_state_v2(reader_handle=reader_handle)
tf_export("raw_ops.ReaderSerializeStateV2")(ReaderSerializeStateV2)
...
def restore(file_pattern, tensor_name, dt, preferred_shard=-1, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "Restore",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Restore(file_pattern, tensor_name, dt, preferred_shard):
  return restore(file_pattern=file_pattern, tensor_name=tensor_name, dt=dt, preferred_shard=preferred_shard)
tf_export("raw_ops.Restore")(Restore)
...
def restore_slice(file_pattern, tensor_name, shape_and_slice, dt, preferred_shard=-1, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "RestoreSlice", name, _ctx._post_execution_callbacks, file_pattern,
        tensor_name, shape_and_slice, "dt", dt, "preferred_shard",
        preferred_shard)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RestoreSlice(file_pattern, tensor_name, shape_and_slice, dt, preferred_shard):
  return restore_slice(file_pattern=file_pattern, tensor_name=tensor_name, shape_and_slice=shape_and_slice, dt=dt, preferred_shard=preferred_shard)
tf_export("raw_ops.RestoreSlice")(RestoreSlice)
...
def restore_v2(prefix, tensor_names, shape_and_slices, dtypes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "RestoreV2", name, _ctx._post_execution_callbacks, prefix,
        tensor_names, shape_and_slices, "dtypes", dtypes)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RestoreV2(prefix, tensor_names, shape_and_slices, dtypes):
  return restore_v2(prefix=prefix, tensor_names=tensor_names, shape_and_slices=shape_and_slices, dtypes=dtypes)
tf_export("raw_ops.RestoreV2")(RestoreV2)
...
def save(filename, tensor_names, data, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "Save",
        name, _ctx._post_execution_callbacks, filename, tensor_names, data)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Save(filename, tensor_names, data):
  return save(filename=filename, tensor_names=tensor_names, data=data)
tf_export("raw_ops.Save")(Save)
  ...
  *  `start,length` where `start` and `length` are integers.  In that
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SaveSlices", name, _ctx._post_execution_callbacks, filename,
        tensor_names, shapes_and_slices, data)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SaveSlices(filename, tensor_names, shapes_and_slices, data):
  return save_slices(filename=filename, tensor_names=tensor_names, shapes_and_slices=shapes_and_slices, data=data)
tf_export("raw_ops.SaveSlices")(SaveSlices)
...
def save_v2(prefix, tensor_names, shape_and_slices, tensors, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "SaveV2",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SaveV2(prefix, tensor_names, shape_and_slices, tensors):
  return save_v2(prefix=prefix, tensor_names=tensor_names, shape_and_slices=shape_and_slices, tensors=tensors)
tf_export("raw_ops.SaveV2")(SaveV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ShardedFilename(basename, shard, num_shards):
  return sharded_filename(basename=basename, shard=shard, num_shards=num_shards)
tf_export("raw_ops.ShardedFilename")(ShardedFilename)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ShardedFilespec(basename, num_shards):
  return sharded_filespec(basename=basename, num_shards=num_shards)
tf_export("raw_ops.ShardedFilespec")(ShardedFilespec)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TFRecordReader(container, shared_name, compression_type):
  return tf_record_reader(container=container, shared_name=shared_name, compression_type=compression_type)
tf_export("raw_ops.TFRecordReader")(TFRecordReader)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TFRecordReaderV2(container, shared_name, compression_type):
  return tf_record_reader_v2(container=container, shared_name=shared_name, compression_type=compression_type)
tf_export("raw_ops.TFRecordReaderV2")(TFRecordReaderV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TextLineReader(skip_header_lines, container, shared_name):
  return text_line_reader(skip_header_lines=skip_header_lines, container=container, shared_name=shared_name)
tf_export("raw_ops.TextLineReader")(TextLineReader)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TextLineReaderV2(skip_header_lines, container, shared_name):
  return text_line_reader_v2(skip_header_lines=skip_header_lines, container=container, shared_name=shared_name)
tf_export("raw_ops.TextLineReaderV2")(TextLineReaderV2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def WholeFileReader(container, shared_name):
  return whole_file_reader(container=container, shared_name=shared_name)
tf_export("raw_ops.WholeFileReader")(WholeFileReader)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def WholeFileReaderV2(container, shared_name):
  return whole_file_reader_v2(container=container, shared_name=shared_name)
tf_export("raw_ops.WholeFileReaderV2")(WholeFileReaderV2)
...
def write_file(filename, contents, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteFile", name, _ctx._post_execution_callbacks, filename, contents)
      return _result
    except _core._FallbackException:
      try:
...
def WriteFile(filename, contents):
  return write_file(filename=filename, contents=contents)
tf_export("raw_ops.WriteFile")(WriteFile)
