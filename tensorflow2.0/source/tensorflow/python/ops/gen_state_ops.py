...
@_kwarg_only
def Assign(ref, value, validate_shape, use_locking):
  return assign(ref=ref, value=value, validate_shape=validate_shape, use_locking=use_locking)
tf_export("raw_ops.Assign")(Assign)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AssignAdd(ref, value, use_locking):
  return assign_add(ref=ref, value=value, use_locking=use_locking)
tf_export("raw_ops.AssignAdd")(AssignAdd)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AssignSub(ref, value, use_locking):
  return assign_sub(ref=ref, value=value, use_locking=use_locking)
tf_export("raw_ops.AssignSub")(AssignSub)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def CountUpTo(ref, limit):
  return count_up_to(ref=ref, limit=limit)
tf_export("raw_ops.CountUpTo")(CountUpTo)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DestroyTemporaryVariable(ref, var_name):
  return destroy_temporary_variable(ref=ref, var_name=var_name)
tf_export("raw_ops.DestroyTemporaryVariable")(DestroyTemporaryVariable)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IsVariableInitialized(ref):
  return is_variable_initialized(ref=ref)
tf_export("raw_ops.IsVariableInitialized")(IsVariableInitialized)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceCountUpTo(resource, limit, T):
  return resource_count_up_to(resource=resource, limit=limit, T=T)
tf_export("raw_ops.ResourceCountUpTo")(ResourceCountUpTo)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterNdAdd(ref, indices, updates, use_locking):
  return resource_scatter_nd_add(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ResourceScatterNdAdd")(ResourceScatterNdAdd)
...
def resource_scatter_nd_sub(ref, indices, updates, use_locking=True, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ResourceScatterNdSub", name, _ctx._post_execution_callbacks, ref,
        indices, updates, "use_locking", use_locking)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterNdSub(ref, indices, updates, use_locking):
  return resource_scatter_nd_sub(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ResourceScatterNdSub")(ResourceScatterNdSub)


def resource_scatter_nd_sub_eager_fallback(ref, indices, updates, use_locking=True, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function resource_scatter_nd_sub
  """
  _ctx = ctx if ctx else _context.context()
  if use_locking is None:
    use_locking = True
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceScatterNdUpdate(ref, indices, updates, use_locking):
  return resource_scatter_nd_update(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ResourceScatterNdUpdate")(ResourceScatterNdUpdate)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterAdd(ref, indices, updates, use_locking):
  return scatter_add(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterAdd")(ScatterAdd)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterDiv(ref, indices, updates, use_locking):
  return scatter_div(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterDiv")(ScatterDiv)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterMax(ref, indices, updates, use_locking):
  return scatter_max(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterMax")(ScatterMax)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterMin(ref, indices, updates, use_locking):
  return scatter_min(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterMin")(ScatterMin)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterMul(ref, indices, updates, use_locking):
  return scatter_mul(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterMul")(ScatterMul)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterNdAdd(ref, indices, updates, use_locking):
  return scatter_nd_add(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterNdAdd")(ScatterNdAdd)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterNdSub(ref, indices, updates, use_locking):
  return scatter_nd_sub(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterNdSub")(ScatterNdSub)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterNdUpdate(ref, indices, updates, use_locking):
  return scatter_nd_update(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterNdUpdate")(ScatterNdUpdate)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterSub(ref, indices, updates, use_locking):
  return scatter_sub(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterSub")(ScatterSub)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ScatterUpdate(ref, indices, updates, use_locking):
  return scatter_update(ref=ref, indices=indices, updates=updates, use_locking=use_locking)
tf_export("raw_ops.ScatterUpdate")(ScatterUpdate)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TemporaryVariable(shape, dtype, var_name):
  return temporary_variable(shape=shape, dtype=dtype, var_name=var_name)
tf_export("raw_ops.TemporaryVariable")(TemporaryVariable)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Variable(shape, dtype, container, shared_name):
  return variable(shape=shape, dtype=dtype, container=container, shared_name=shared_name)
tf_export("raw_ops.Variable")(Variable)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def VariableV2(shape, dtype, container, shared_name):
  return variable_v2(shape=shape, dtype=dtype, container=container, shared_name=shared_name)
tf_export("raw_ops.VariableV2")(VariableV2)
