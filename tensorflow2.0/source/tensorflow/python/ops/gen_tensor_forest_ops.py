...
@_kwarg_only
def TensorForestCreateTreeVariable(tree_handle, tree_config):
  return tensor_forest_create_tree_variable(tree_handle=tree_handle, tree_config=tree_config)
tf_export("raw_ops.TensorForestCreateTreeVariable")(TensorForestCreateTreeVariable)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorForestTreeDeserialize(tree_handle, tree_config):
  return tensor_forest_tree_deserialize(tree_handle=tree_handle, tree_config=tree_config)
tf_export("raw_ops.TensorForestTreeDeserialize")(TensorForestTreeDeserialize)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorForestTreeIsInitializedOp(tree_handle):
  return tensor_forest_tree_is_initialized_op(tree_handle=tree_handle)
tf_export("raw_ops.TensorForestTreeIsInitializedOp")(TensorForestTreeIsInitializedOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorForestTreePredict(tree_handle, dense_features, logits_dimension):
  return tensor_forest_tree_predict(tree_handle=tree_handle, dense_features=dense_features, logits_dimension=logits_dimension)
tf_export("raw_ops.TensorForestTreePredict")(TensorForestTreePredict)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorForestTreeResourceHandleOp(container, shared_name):
  return tensor_forest_tree_resource_handle_op(container=container, shared_name=shared_name)
tf_export("raw_ops.TensorForestTreeResourceHandleOp")(TensorForestTreeResourceHandleOp)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorForestTreeSerialize(tree_handle):
  return tensor_forest_tree_serialize(tree_handle=tree_handle)
tf_export("raw_ops.TensorForestTreeSerialize")(TensorForestTreeSerialize)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TensorForestTreeSize(tree_handle):
  return tensor_forest_tree_size(tree_handle=tree_handle)
tf_export("raw_ops.TensorForestTreeSize")(TensorForestTreeSize)
