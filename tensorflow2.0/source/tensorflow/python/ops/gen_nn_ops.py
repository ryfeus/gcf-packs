...
@_kwarg_only
def AvgPool(value, ksize, strides, padding, data_format):
  return avg_pool(value=value, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "AvgPool3D", name, _ctx._post_execution_callbacks, input, "ksize",
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AvgPool3D(input, ksize, strides, padding, data_format):
  return avg_pool3d(input=input, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AvgPool3DGrad(orig_input_shape, grad, ksize, strides, padding, data_format):
  return avg_pool3d_grad(orig_input_shape=orig_input_shape, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
def avg_pool_grad(orig_input_shape, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "AvgPoolGrad", name, _ctx._post_execution_callbacks, orig_input_shape,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AvgPoolGrad(orig_input_shape, grad, ksize, strides, padding, data_format):
  return avg_pool_grad(orig_input_shape=orig_input_shape, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchNormWithGlobalNormalization(t, m, v, beta, gamma, variance_epsilon, scale_after_normalization):
  return _batch_norm_with_global_normalization(t=t, m=m, v=v, beta=beta, gamma=gamma, variance_epsilon=variance_epsilon, scale_after_normalization=scale_after_normalization)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BatchNormWithGlobalNormalizationGrad(t, m, v, gamma, backprop, variance_epsilon, scale_after_normalization):
  return batch_norm_with_global_normalization_grad(t=t, m=m, v=v, gamma=gamma, backprop=backprop, variance_epsilon=variance_epsilon, scale_after_normalization=scale_after_normalization)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BiasAdd(value, bias, data_format):
  return bias_add(value=value, bias=bias, data_format=data_format)
...
def bias_add_grad(out_backprop, data_format="NHWC", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "BiasAddGrad", name, _ctx._post_execution_callbacks, out_backprop,
        "data_format", data_format)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BiasAddGrad(out_backprop, data_format):
  return bias_add_grad(out_backprop=out_backprop, data_format=data_format)
...
def bias_add_v1(value, bias, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "BiasAddV1", name, _ctx._post_execution_callbacks, value, bias)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def BiasAddV1(value, bias):
  return bias_add_v1(value=value, bias=bias)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv2D(input, filter, strides, use_cudnn_on_gpu, padding, explicit_paddings, data_format, dilations):
  return conv2d(input=input, filter=filter, strides=strides, use_cudnn_on_gpu=use_cudnn_on_gpu, padding=padding, explicit_paddings=explicit_paddings, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv2DBackpropFilter(input, filter_sizes, out_backprop, strides, use_cudnn_on_gpu, padding, explicit_paddings, data_format, dilations):
  return conv2d_backprop_filter(input=input, filter_sizes=filter_sizes, out_backprop=out_backprop, strides=strides, use_cudnn_on_gpu=use_cudnn_on_gpu, padding=padding, explicit_paddings=explicit_paddings, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv2DBackpropInput(input_sizes, filter, out_backprop, strides, use_cudnn_on_gpu, padding, explicit_paddings, data_format, dilations):
  return conv2d_backprop_input(input_sizes=input_sizes, filter=filter, out_backprop=out_backprop, strides=strides, use_cudnn_on_gpu=use_cudnn_on_gpu, padding=padding, explicit_paddings=explicit_paddings, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv3D(input, filter, strides, padding, data_format, dilations):
  return conv3d(input=input, filter=filter, strides=strides, padding=padding, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv3DBackpropFilter(input, filter, out_backprop, strides, padding, dilations):
  return conv3d_backprop_filter(input=input, filter=filter, out_backprop=out_backprop, strides=strides, padding=padding, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv3DBackpropFilterV2(input, filter_sizes, out_backprop, strides, padding, data_format, dilations):
  return conv3d_backprop_filter_v2(input=input, filter_sizes=filter_sizes, out_backprop=out_backprop, strides=strides, padding=padding, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv3DBackpropInput(input, filter, out_backprop, strides, padding, dilations):
  return conv3d_backprop_input(input=input, filter=filter, out_backprop=out_backprop, strides=strides, padding=padding, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Conv3DBackpropInputV2(input_sizes, filter, out_backprop, strides, padding, data_format, dilations):
  return conv3d_backprop_input_v2(input_sizes=input_sizes, filter=filter, out_backprop=out_backprop, strides=strides, padding=padding, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DataFormatDimMap(x, src_format, dst_format):
  return data_format_dim_map(x=x, src_format=src_format, dst_format=dst_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DataFormatVecPermute(x, src_format, dst_format):
  return data_format_vec_permute(x=x, src_format=src_format, dst_format=dst_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DepthwiseConv2dNative(input, filter, strides, padding, data_format, dilations):
  return depthwise_conv2d_native(input=input, filter=filter, strides=strides, padding=padding, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DepthwiseConv2dNativeBackpropFilter(input, filter_sizes, out_backprop, strides, padding, data_format, dilations):
  return depthwise_conv2d_native_backprop_filter(input=input, filter_sizes=filter_sizes, out_backprop=out_backprop, strides=strides, padding=padding, data_format=data_format, dilations=dilations)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DepthwiseConv2dNativeBackpropInput(input_sizes, filter, out_backprop, strides, padding, data_format, dilations):
  return depthwise_conv2d_native_backprop_input(input_sizes=input_sizes, filter=filter, out_backprop=out_backprop, strides=strides, padding=padding, data_format=data_format, dilations=dilations)
...
def dilation2d(input, filter, strides, rates, padding, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Dilation2D", name, _ctx._post_execution_callbacks, input, filter,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Dilation2D(input, filter, strides, rates, padding):
  return dilation2d(input=input, filter=filter, strides=strides, rates=rates, padding=padding)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Dilation2DBackpropFilter(input, filter, out_backprop, strides, rates, padding):
  return dilation2d_backprop_filter(input=input, filter=filter, out_backprop=out_backprop, strides=strides, rates=rates, padding=padding)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Dilation2DBackpropInput(input, filter, out_backprop, strides, rates, padding):
  return dilation2d_backprop_input(input=input, filter=filter, out_backprop=out_backprop, strides=strides, rates=rates, padding=padding)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def EluGrad(gradients, outputs):
  return elu_grad(gradients=gradients, outputs=outputs)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FractionalAvgPool(value, pooling_ratio, pseudo_random, overlapping, deterministic, seed, seed2):
  return fractional_avg_pool(value=value, pooling_ratio=pooling_ratio, pseudo_random=pseudo_random, overlapping=overlapping, deterministic=deterministic, seed=seed, seed2=seed2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FractionalAvgPoolGrad(orig_input_tensor_shape, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping):
  return fractional_avg_pool_grad(orig_input_tensor_shape=orig_input_tensor_shape, out_backprop=out_backprop, row_pooling_sequence=row_pooling_sequence, col_pooling_sequence=col_pooling_sequence, overlapping=overlapping)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FractionalMaxPool(value, pooling_ratio, pseudo_random, overlapping, deterministic, seed, seed2):
  return fractional_max_pool(value=value, pooling_ratio=pooling_ratio, pseudo_random=pseudo_random, overlapping=overlapping, deterministic=deterministic, seed=seed, seed2=seed2)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FractionalMaxPoolGrad(orig_input, orig_output, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping):
  return fractional_max_pool_grad(orig_input=orig_input, orig_output=orig_output, out_backprop=out_backprop, row_pooling_sequence=row_pooling_sequence, col_pooling_sequence=col_pooling_sequence, overlapping=overlapping)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FusedBatchNorm(x, scale, offset, mean, variance, epsilon, data_format, is_training):
  return _fused_batch_norm(x=x, scale=scale, offset=offset, mean=mean, variance=variance, epsilon=epsilon, data_format=data_format, is_training=is_training)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FusedBatchNormGrad(y_backprop, x, scale, reserve_space_1, reserve_space_2, epsilon, data_format, is_training):
  return fused_batch_norm_grad(y_backprop=y_backprop, x=x, scale=scale, reserve_space_1=reserve_space_1, reserve_space_2=reserve_space_2, epsilon=epsilon, data_format=data_format, is_training=is_training)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FusedBatchNormGradV2(y_backprop, x, scale, reserve_space_1, reserve_space_2, epsilon, data_format, is_training):
  return fused_batch_norm_grad_v2(y_backprop=y_backprop, x=x, scale=scale, reserve_space_1=reserve_space_1, reserve_space_2=reserve_space_2, epsilon=epsilon, data_format=data_format, is_training=is_training)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FusedBatchNormV2(x, scale, offset, mean, variance, epsilon, data_format, is_training):
  return fused_batch_norm_v2(x=x, scale=scale, offset=offset, mean=mean, variance=variance, epsilon=epsilon, data_format=data_format, is_training=is_training)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FusedPadConv2D(input, paddings, filter, mode, strides, padding):
  return fused_pad_conv2d(input=input, paddings=paddings, filter=filter, mode=mode, strides=strides, padding=padding)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FusedResizeAndPadConv2D(input, size, paddings, filter, resize_align_corners, mode, strides, padding):
  return fused_resize_and_pad_conv2d(input=input, size=size, paddings=paddings, filter=filter, resize_align_corners=resize_align_corners, mode=mode, strides=strides, padding=padding)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, predictions, targets, "k", k)
      return _result
    except _core._FallbackException:
      try:
...
def InTopK(predictions, targets, k):
  return in_top_k(predictions=predictions, targets=targets, k=k)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InTopKV2(predictions, targets, k):
  return in_top_kv2(predictions=predictions, targets=targets, k=k)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, t)
      return _result
    except _core._FallbackException:
      try:
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, input, "depth_radius",
...
def LRN(input, depth_radius, bias, alpha, beta):
  return lrn(input=input, depth_radius=depth_radius, bias=bias, alpha=alpha, beta=beta)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LRNGrad(input_grads, input_image, output_image, depth_radius, bias, alpha, beta):
  return lrn_grad(input_grads=input_grads, input_image=input_image, output_image=output_image, depth_radius=depth_radius, bias=bias, alpha=alpha, beta=beta)
...
def leaky_relu(features, alpha=0.2, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "LeakyRelu", name, _ctx._post_execution_callbacks, features, "alpha",
        alpha)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LeakyRelu(features, alpha):
  return leaky_relu(features=features, alpha=alpha)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def LeakyReluGrad(gradients, features, alpha):
  return leaky_relu_grad(gradients=gradients, features=features, alpha=alpha)
...
def log_softmax(logits, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "LogSoftmax", name, _ctx._post_execution_callbacks, logits)
      return _result
    except _core._FallbackException:
      try:
...
def LogSoftmax(logits):
  return log_softmax(logits=logits)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPool(input, ksize, strides, padding, data_format):
  return max_pool(input=input, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
def max_pool3d(input, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MaxPool3D", name, _ctx._post_execution_callbacks, input, "ksize",
        ksize, "strides", strides, "padding", padding, "data_format",
        data_format)
      return _result
    except _core._FallbackException:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPool3D(input, ksize, strides, padding, data_format):
  return max_pool3d(input=input, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPool3DGrad(orig_input, orig_output, grad, ksize, strides, padding, data_format):
  return max_pool3d_grad(orig_input=orig_input, orig_output=orig_output, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPool3DGradGrad(orig_input, orig_output, grad, ksize, strides, padding, data_format):
  return max_pool3d_grad_grad(orig_input=orig_input, orig_output=orig_output, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
def max_pool_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MaxPoolGrad", name, _ctx._post_execution_callbacks, orig_input,
        orig_output, grad, "ksize", ksize, "strides", strides, "padding",
        padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGrad(orig_input, orig_output, grad, ksize, strides, padding, data_format):
  return max_pool_grad(orig_input=orig_input, orig_output=orig_output, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGradGrad(orig_input, orig_output, grad, ksize, strides, padding, data_format):
  return max_pool_grad_grad(orig_input=orig_input, orig_output=orig_output, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGradGradV2(orig_input, orig_output, grad, ksize, strides, padding, data_format):
  return max_pool_grad_grad_v2(orig_input=orig_input, orig_output=orig_output, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGradGradWithArgmax(input, grad, argmax, ksize, strides, padding):
  return max_pool_grad_grad_with_argmax(input=input, grad=grad, argmax=argmax, ksize=ksize, strides=strides, padding=padding)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGradV2(orig_input, orig_output, grad, ksize, strides, padding, data_format):
  return max_pool_grad_v2(orig_input=orig_input, orig_output=orig_output, grad=grad, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolGradWithArgmax(input, grad, argmax, ksize, strides, padding):
  return max_pool_grad_with_argmax(input=input, grad=grad, argmax=argmax, ksize=ksize, strides=strides, padding=padding)
...
def max_pool_v2(input, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MaxPoolV2", name, _ctx._post_execution_callbacks, input, ksize,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolV2(input, ksize, strides, padding, data_format):
  return max_pool_v2(input=input, ksize=ksize, strides=strides, padding=padding, data_format=data_format)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def MaxPoolWithArgmax(input, ksize, strides, Targmax, padding):
  return max_pool_with_argmax(input=input, ksize=ksize, strides=strides, Targmax=Targmax, padding=padding)
...
def nth_element(input, n, reverse=False, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "NthElement", name, _ctx._post_execution_callbacks, input, n,
        "reverse", reverse)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NthElement(input, n, reverse):
  return nth_element(input=input, n=n, reverse=reverse)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedAvgPool(input, min_input, max_input, ksize, strides, padding):
  return quantized_avg_pool(input=input, min_input=min_input, max_input=max_input, ksize=ksize, strides=strides, padding=padding)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedBatchNormWithGlobalNormalization(t, t_min, t_max, m, m_min, m_max, v, v_min, v_max, beta, beta_min, beta_max, gamma, gamma_min, gamma_max, out_type, variance_epsilon, scale_after_normalization):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedBiasAdd(input, bias, min_input, max_input, min_bias, max_bias, out_type):
  return quantized_bias_add(input=input, bias=bias, min_input=min_input, max_input=max_input, min_bias=min_bias, max_bias=max_bias, out_type=out_type)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2D(input, filter, min_input, max_input, min_filter, max_filter, out_type, strides, padding, dilations):
  return quantized_conv2d(input=input, filter=filter, min_input=min_input, max_input=max_input, min_filter=min_filter, max_filter=max_filter, out_type=out_type, strides=strides, padding=padding, dilations=dilations)
...
def quantized_conv2d_and_relu(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedConv2DAndRelu", name, _ctx._post_execution_callbacks, input,
        filter, min_input, max_input, min_filter, max_filter, "out_type",
        out_type, "strides", strides, "padding", padding, "dilations",
  ...
  _attrs = ("Tinput", _op.get_attr("Tinput"), "Tfilter",
            ...
            "strides", _op.get_attr("strides"), "padding",
            _op.get_attr("padding"), "dilations", _op.get_attr("dilations"),
            "padding_list", _op.get_attr("padding_list"))
  _execute.record_gradient(
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DAndRelu(input, filter, min_input, max_input, min_filter, max_filter, out_type, strides, padding, dilations, padding_list):
  return quantized_conv2d_and_relu(input=input, filter=filter, min_input=min_input, max_input=max_input, min_filter=min_filter, max_filter=max_filter, out_type=out_type, strides=strides, padding=padding, dilations=dilations, padding_list=padding_list)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DAndReluAndRequantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, out_type, strides, padding, dilations, padding_list):
  return quantized_conv2d_and_relu_and_requantize(input=input, filter=filter, min_input=min_input, max_input=max_input, min_filter=min_filter, max_filter=max_filter, min_freezed_output=min_freezed_output, max_freezed_output=max_freezed_output, out_type=out_type, strides=strides, padding=padding, dilations=dilations, padding_list=padding_list)
...
def quantized_conv2d_and_requantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedConv2DAndRequantize", name, _ctx._post_execution_callbacks,
        input, filter, min_input, max_input, min_filter, max_filter,
        min_freezed_output, max_freezed_output, "out_type", out_type,
        "strides", strides, "padding", padding, "dilations", dilations,
        "padding_list", padding_list)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DAndRequantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, out_type, strides, padding, dilations, padding_list):
...
def quantized_conv2d_with_bias(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedConv2DWithBias", name, _ctx._post_execution_callbacks,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DWithBias(input, filter, bias, min_input, max_input, min_filter, max_filter, out_type, strides, padding, dilations, padding_list):
  return quantized_conv2d_with_bias(input=input, filter=filter, bias=bias, min_input=min_input, max_input=max_input, min_filter=min_filter, max_filter=max_filter, out_type=out_type, strides=strides, padding=padding, dilations=dilations, padding_list=padding_list)
...
def quantized_conv2d_with_bias_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedConv2DWithBiasAndRelu", name,
        _ctx._post_execution_callbacks, input, filter, bias, min_input,
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DWithBiasAndRelu(input, filter, bias, min_input, max_input, min_filter, max_filter, out_type, strides, padding, dilations, padding_list):
  return quantized_conv2d_with_bias_and_relu(input=input, filter=filter, bias=bias, min_input=min_input, max_input=max_input, min_filter=min_filter, max_filter=max_filter, out_type=out_type, strides=strides, padding=padding, dilations=dilations, padding_list=padding_list)
...
def quantized_conv2d_with_bias_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  _inputs_flat = _op.inputs
  _attrs = ("Tinput", _op.get_attr("Tinput"), "Tfilter",
            _op.get_attr("Tfilter"), "Tbias", _op.get_attr("Tbias"),
            "out_type", _op.get_attr("out_type"), "strides",
            _op.get_attr("strides"), "padding", _op.get_attr("padding"),
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DWithBiasAndReluAndRequantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, out_type, strides, padding, dilations, padding_list):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DWithBiasAndRequantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, out_type, strides, padding, dilations, padding_list):
...
def quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  _attrs = ("Tinput", _op.get_attr("Tinput"), "Tfilter",
            _op.get_attr("Tfilter"), "Tbias", _op.get_attr("Tbias"),
            "Tsummand", _op.get_attr("Tsummand"), "out_type",
            _op.get_attr("out_type"), "strides", _op.get_attr("strides"),
            "padding", _op.get_attr("padding"), "dilations",
            _op.get_attr("dilations"), "padding_list",
            _op.get_attr("padding_list"))
  _execute.record_gradient(
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DWithBiasSignedSumAndReluAndRequantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, out_type, strides, padding, dilations, padding_list):
  return quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize(input=input, filter=filter, bias=bias, min_input=min_input, max_input=max_input, min_filter=min_filter, max_filter=max_filter, min_freezed_output=min_freezed_output, max_freezed_output=max_freezed_output, summand=summand, min_summand=min_summand, max_summand=max_summand, out_type=out_type, strides=strides, padding=padding, dilations=dilations, padding_list=padding_list)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DWithBiasSumAndRelu(input, filter, bias, min_input, max_input, min_filter, max_filter, summand, out_type, strides, padding, dilations, padding_list):
  return quantized_conv2d_with_bias_sum_and_relu(input=input, filter=filter, bias=bias, min_input=min_input, max_input=max_input, min_filter=min_filter, max_filter=max_filter, summand=summand, out_type=out_type, strides=strides, padding=padding, dilations=dilations, padding_list=padding_list)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedConv2DWithBiasSumAndReluAndRequantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, out_type, strides, padding, dilations, padding_list):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedMaxPool(input, min_input, max_input, ksize, strides, padding):
  return quantized_max_pool(input=input, min_input=min_input, max_input=max_input, ksize=ksize, strides=strides, padding=padding)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedRelu(features, min_features, max_features, out_type):
  return quantized_relu(features=features, min_features=min_features, max_features=max_features, out_type=out_type)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedRelu6(features, min_features, max_features, out_type):
  return quantized_relu6(features=features, min_features=min_features, max_features=max_features, out_type=out_type)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def QuantizedReluX(features, max_value, min_features, max_features, out_type):
  return quantized_relu_x(features=features, max_value=max_value, min_features=min_features, max_features=max_features, out_type=out_type)
...
@_kwarg_only
def Relu6(features):
  return relu6(features=features)
...
def relu6_grad(gradients, features, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Relu6Grad", name, _ctx._post_execution_callbacks, gradients,
        features)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def Relu6Grad(gradients, features):
  return relu6_grad(gradients=gradients, features=features)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReluGrad(gradients, features):
  return relu_grad(gradients=gradients, features=features)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SeluGrad(gradients, outputs):
  return selu_grad(gradients=gradients, outputs=outputs)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SoftmaxCrossEntropyWithLogits(features, labels):
  return softmax_cross_entropy_with_logits(features=features, labels=labels)
...
def Softplus(features):
  return softplus(features=features)
...
def softplus_grad(gradients, features, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SoftplusGrad", name, _ctx._post_execution_callbacks, gradients,
        features)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SoftplusGrad(gradients, features):
  return softplus_grad(gradients=gradients, features=features)
...
def Softsign(features):
  return softsign(features=features)
...
def softsign_grad(gradients, features, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SoftsignGrad", name, _ctx._post_execution_callbacks, gradients,
        features)
      return _result
    except _core._FallbackException:
      try:
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SoftsignGrad(gradients, features):
  return softsign_grad(gradients=gradients, features=features)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseSoftmaxCrossEntropyWithLogits(features, labels):
  return sparse_softmax_cross_entropy_with_logits(features=features, labels=labels)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, input, "k", k, "sorted", sorted)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TopK(input, k, sorted):
  return top_k(input=input, k=k, sorted=sorted)
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, input, k, "sorted", sorted)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TopKV2(input, k, sorted):
  return top_kv2(input=input, k=k, sorted=sorted)
