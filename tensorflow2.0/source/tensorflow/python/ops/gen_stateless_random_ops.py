...
@_kwarg_only
def StatelessMultinomial(logits, num_samples, seed, output_dtype):
  return stateless_multinomial(logits=logits, num_samples=num_samples, seed=seed, output_dtype=output_dtype)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatelessRandomNormal(shape, seed, dtype):
  return stateless_random_normal(shape=shape, seed=seed, dtype=dtype)
tf_export("raw_ops.StatelessRandomNormal")(StatelessRandomNormal)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatelessRandomUniform(shape, seed, dtype):
  return stateless_random_uniform(shape=shape, seed=seed, dtype=dtype)
tf_export("raw_ops.StatelessRandomUniform")(StatelessRandomUniform)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatelessRandomUniformInt(shape, seed, minval, maxval):
  return stateless_random_uniform_int(shape=shape, seed=seed, minval=minval, maxval=maxval)
tf_export("raw_ops.StatelessRandomUniformInt")(StatelessRandomUniformInt)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StatelessTruncatedNormal(shape, seed, dtype):
  return stateless_truncated_normal(shape=shape, seed=seed, dtype=dtype)
tf_export("raw_ops.StatelessTruncatedNormal")(StatelessTruncatedNormal)
