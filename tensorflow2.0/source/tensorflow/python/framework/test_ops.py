...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AttrEmptyListDefault(a):
  return attr_empty_list_default(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AttrListDefault(a):
  return attr_list_default(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AttrListTypeDefault(a, b):
  return attr_list_type_default(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AttrPartialShape(a):
  return attr_partial_shape(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AttrPartialShapeList(a):
  return attr_partial_shape_list(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def AttrTypeDefault(a):
  return attr_type_default(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ComplexStruct(n_a, n_b, t_c):
  return complex_struct(n_a=n_a, n_b=n_b, t_c=t_c)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DefaultAttrs(string_val, string_list_val, int_val, int_list_val, float_val, float_list_val, bool_val, bool_list_val, type_val, type_list_val, shape_val, shape_list_val, tensor_val, tensor_list_val):
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def DevicePlacementOp():
  return device_placement_op()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FiveFloatOutputs():
  return five_float_outputs()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def FloatOutputStringOutput():
  return float_output_string_output()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def InPolymorphicTwice(a, b):
  return in_polymorphic_twice(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IntInputFloatInput(a, b):
  return int_input_float_input(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IntInputIntOutput(a):
  return int_input_int_output(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def IntOutputFloatOutput():
  return int_output_float_output()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def KernelLabelRequired(input):
  return kernel_label_required(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NInPolymorphicTwice(a, b):
  return n_in_polymorphic_twice(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NInTwoTypeVariables(a, b):
  return n_in_two_type_variables(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NIntsOutDefault(N):
  return n_ints_out_default(N=N)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NPolymorphicIn(a):
  return n_polymorphic_in(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NPolymorphicOut(T, N):
  return n_polymorphic_out(T=T, N=N)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NPolymorphicOutDefault(T, N):
  return n_polymorphic_out_default(T=T, N=N)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NPolymorphicRestrictIn(a):
  return n_polymorphic_restrict_in(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def NPolymorphicRestrictOut(T, N):
  return n_polymorphic_restrict_out(T=T, N=N)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OpWithDefaultAttr(default_float):
  return op_with_default_attr(default_float=default_float)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OpWithFutureDefaultAttr():
  return op_with_future_default_attr()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def OutTypeListRestrict(t):
  return out_type_list_restrict(t=t)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PolymorphicDefaultOut(T):
  return polymorphic_default_out(T=T)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def PolymorphicOut(T):
  return polymorphic_out(T=T)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefInputFloatInput(a, b):
  return ref_input_float_input(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefInputFloatInputIntOutput(a, b):
  return ref_input_float_input_int_output(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefInputIntInput(a, b):
  return ref_input_int_input(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RefOutputFloatOutput():
  return ref_output_float_output()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def RequiresOlderGraphVersion():
  return requires_older_graph_version()
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReservedAttr(range):
  return reserved_attr(range=range)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ReservedInput(input):
  return reserved_input(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceCreateOp(resource):
  return resource_create_op(resource=resource)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceInitializedOp(resource):
  return resource_initialized_op(resource=resource)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceUsingOp(resource):
  return resource_using_op(resource=resource)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SimpleStruct(n_a):
  return simple_struct(n_a=n_a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StringListAttr(a, b):
  return string_list_attr(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def StubResourceHandleOp(container, shared_name):
  return stub_resource_handle_op(container=container, shared_name=shared_name)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TestStringOutput(input):
  return test_string_output(input=input)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TwoFloatInputs(a, b):
  return two_float_inputs(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TwoFloatInputsFloatOutput(a, b):
  return two_float_inputs_float_output(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TwoFloatInputsIntOutput(a, b):
  return two_float_inputs_int_output(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TwoIntInputs(a, b):
  return two_int_inputs(a=a, b=b)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TypeListRestrict(a):
  return type_list_restrict(a=a)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def TypeListTwice(a, b):
  return type_list_twice(a=a, b=b)
