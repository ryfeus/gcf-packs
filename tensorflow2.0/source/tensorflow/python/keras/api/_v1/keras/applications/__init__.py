...
from tensorflow.python.keras.api._v1.keras.applications import densenet
from tensorflow.python.keras.api._v1.keras.applications import inception_resnet_v2
