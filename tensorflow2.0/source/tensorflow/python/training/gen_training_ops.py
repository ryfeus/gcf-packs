...
@_kwarg_only
def ApplyAdaMax(var, m, v, beta1_power, lr, beta1, beta2, epsilon, grad, use_locking):
  return apply_ada_max(var=var, m=m, v=v, beta1_power=beta1_power, lr=lr, beta1=beta1, beta2=beta2, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyAdadelta(var, accum, accum_update, lr, rho, epsilon, grad, use_locking):
  return apply_adadelta(var=var, accum=accum, accum_update=accum_update, lr=lr, rho=rho, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyAdagrad(var, accum, lr, grad, use_locking, update_slots):
  return apply_adagrad(var=var, accum=accum, lr=lr, grad=grad, use_locking=use_locking, update_slots=update_slots)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyAdagradDA(var, gradient_accumulator, gradient_squared_accumulator, grad, lr, l1, l2, global_step, use_locking):
  return apply_adagrad_da(var=var, gradient_accumulator=gradient_accumulator, gradient_squared_accumulator=gradient_squared_accumulator, grad=grad, lr=lr, l1=l1, l2=l2, global_step=global_step, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyAdam(var, m, v, beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_locking, use_nesterov):
  return apply_adam(var=var, m=m, v=v, beta1_power=beta1_power, beta2_power=beta2_power, lr=lr, beta1=beta1, beta2=beta2, epsilon=epsilon, grad=grad, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyAddSign(var, m, lr, alpha, sign_decay, beta, grad, use_locking):
  return apply_add_sign(var=var, m=m, lr=lr, alpha=alpha, sign_decay=sign_decay, beta=beta, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyCenteredRMSProp(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, use_locking):
  return apply_centered_rms_prop(var=var, mg=mg, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyFtrl(var, accum, linear, grad, lr, l1, l2, lr_power, use_locking):
  return apply_ftrl(var=var, accum=accum, linear=linear, grad=grad, lr=lr, l1=l1, l2=l2, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyFtrlV2(var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power, use_locking):
  return apply_ftrl_v2(var=var, accum=accum, linear=linear, grad=grad, lr=lr, l1=l1, l2=l2, l2_shrinkage=l2_shrinkage, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyGradientDescent(var, alpha, delta, use_locking):
  return apply_gradient_descent(var=var, alpha=alpha, delta=delta, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyMomentum(var, accum, lr, grad, momentum, use_locking, use_nesterov):
  return apply_momentum(var=var, accum=accum, lr=lr, grad=grad, momentum=momentum, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyPowerSign(var, m, lr, logbase, sign_decay, beta, grad, use_locking):
  return apply_power_sign(var=var, m=m, lr=lr, logbase=logbase, sign_decay=sign_decay, beta=beta, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyProximalAdagrad(var, accum, lr, l1, l2, grad, use_locking):
  return apply_proximal_adagrad(var=var, accum=accum, lr=lr, l1=l1, l2=l2, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyProximalGradientDescent(var, alpha, l1, l2, delta, use_locking):
  return apply_proximal_gradient_descent(var=var, alpha=alpha, l1=l1, l2=l2, delta=delta, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ApplyRMSProp(var, ms, mom, lr, rho, momentum, epsilon, grad, use_locking):
  return apply_rms_prop(var=var, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyAdaMax(var, m, v, beta1_power, lr, beta1, beta2, epsilon, grad, use_locking):
  return resource_apply_ada_max(var=var, m=m, v=v, beta1_power=beta1_power, lr=lr, beta1=beta1, beta2=beta2, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyAdadelta(var, accum, accum_update, lr, rho, epsilon, grad, use_locking):
  return resource_apply_adadelta(var=var, accum=accum, accum_update=accum_update, lr=lr, rho=rho, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyAdagrad(var, accum, lr, grad, use_locking, update_slots):
  return resource_apply_adagrad(var=var, accum=accum, lr=lr, grad=grad, use_locking=use_locking, update_slots=update_slots)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyAdagradDA(var, gradient_accumulator, gradient_squared_accumulator, grad, lr, l1, l2, global_step, use_locking):
  return resource_apply_adagrad_da(var=var, gradient_accumulator=gradient_accumulator, gradient_squared_accumulator=gradient_squared_accumulator, grad=grad, lr=lr, l1=l1, l2=l2, global_step=global_step, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyAdam(var, m, v, beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_locking, use_nesterov):
  return resource_apply_adam(var=var, m=m, v=v, beta1_power=beta1_power, beta2_power=beta2_power, lr=lr, beta1=beta1, beta2=beta2, epsilon=epsilon, grad=grad, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyAdamWithAmsgrad(var, m, v, vhat, beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_locking):
  return resource_apply_adam_with_amsgrad(var=var, m=m, v=v, vhat=vhat, beta1_power=beta1_power, beta2_power=beta2_power, lr=lr, beta1=beta1, beta2=beta2, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyAddSign(var, m, lr, alpha, sign_decay, beta, grad, use_locking):
  return resource_apply_add_sign(var=var, m=m, lr=lr, alpha=alpha, sign_decay=sign_decay, beta=beta, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyCenteredRMSProp(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, use_locking):
  return resource_apply_centered_rms_prop(var=var, mg=mg, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyFtrl(var, accum, linear, grad, lr, l1, l2, lr_power, use_locking):
  return resource_apply_ftrl(var=var, accum=accum, linear=linear, grad=grad, lr=lr, l1=l1, l2=l2, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyFtrlV2(var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power, use_locking):
  return resource_apply_ftrl_v2(var=var, accum=accum, linear=linear, grad=grad, lr=lr, l1=l1, l2=l2, l2_shrinkage=l2_shrinkage, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyGradientDescent(var, alpha, delta, use_locking):
  return resource_apply_gradient_descent(var=var, alpha=alpha, delta=delta, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyKerasMomentum(var, accum, lr, grad, momentum, use_locking, use_nesterov):
  return resource_apply_keras_momentum(var=var, accum=accum, lr=lr, grad=grad, momentum=momentum, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyMomentum(var, accum, lr, grad, momentum, use_locking, use_nesterov):
  return resource_apply_momentum(var=var, accum=accum, lr=lr, grad=grad, momentum=momentum, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyPowerSign(var, m, lr, logbase, sign_decay, beta, grad, use_locking):
  return resource_apply_power_sign(var=var, m=m, lr=lr, logbase=logbase, sign_decay=sign_decay, beta=beta, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyProximalAdagrad(var, accum, lr, l1, l2, grad, use_locking):
  return resource_apply_proximal_adagrad(var=var, accum=accum, lr=lr, l1=l1, l2=l2, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyProximalGradientDescent(var, alpha, l1, l2, delta, use_locking):
  return resource_apply_proximal_gradient_descent(var=var, alpha=alpha, l1=l1, l2=l2, delta=delta, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceApplyRMSProp(var, ms, mom, lr, rho, momentum, epsilon, grad, use_locking):
  return resource_apply_rms_prop(var=var, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyAdadelta(var, accum, accum_update, lr, rho, epsilon, grad, indices, use_locking):
  return resource_sparse_apply_adadelta(var=var, accum=accum, accum_update=accum_update, lr=lr, rho=rho, epsilon=epsilon, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyAdagrad(var, accum, lr, grad, indices, use_locking, update_slots):
  return resource_sparse_apply_adagrad(var=var, accum=accum, lr=lr, grad=grad, indices=indices, use_locking=use_locking, update_slots=update_slots)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyAdagradDA(var, gradient_accumulator, gradient_squared_accumulator, grad, indices, lr, l1, l2, global_step, use_locking):
  return resource_sparse_apply_adagrad_da(var=var, gradient_accumulator=gradient_accumulator, gradient_squared_accumulator=gradient_squared_accumulator, grad=grad, indices=indices, lr=lr, l1=l1, l2=l2, global_step=global_step, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyCenteredRMSProp(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, indices, use_locking):
  return resource_sparse_apply_centered_rms_prop(var=var, mg=mg, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyFtrl(var, accum, linear, grad, indices, lr, l1, l2, lr_power, use_locking):
  return resource_sparse_apply_ftrl(var=var, accum=accum, linear=linear, grad=grad, indices=indices, lr=lr, l1=l1, l2=l2, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyFtrlV2(var, accum, linear, grad, indices, lr, l1, l2, l2_shrinkage, lr_power, use_locking):
  return resource_sparse_apply_ftrl_v2(var=var, accum=accum, linear=linear, grad=grad, indices=indices, lr=lr, l1=l1, l2=l2, l2_shrinkage=l2_shrinkage, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyKerasMomentum(var, accum, lr, grad, indices, momentum, use_locking, use_nesterov):
  return resource_sparse_apply_keras_momentum(var=var, accum=accum, lr=lr, grad=grad, indices=indices, momentum=momentum, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyMomentum(var, accum, lr, grad, indices, momentum, use_locking, use_nesterov):
  return resource_sparse_apply_momentum(var=var, accum=accum, lr=lr, grad=grad, indices=indices, momentum=momentum, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyProximalAdagrad(var, accum, lr, l1, l2, grad, indices, use_locking):
  return resource_sparse_apply_proximal_adagrad(var=var, accum=accum, lr=lr, l1=l1, l2=l2, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyProximalGradientDescent(var, alpha, l1, l2, grad, indices, use_locking):
  return resource_sparse_apply_proximal_gradient_descent(var=var, alpha=alpha, l1=l1, l2=l2, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def ResourceSparseApplyRMSProp(var, ms, mom, lr, rho, momentum, epsilon, grad, indices, use_locking):
  return resource_sparse_apply_rms_prop(var=var, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyAdadelta(var, accum, accum_update, lr, rho, epsilon, grad, indices, use_locking):
  return sparse_apply_adadelta(var=var, accum=accum, accum_update=accum_update, lr=lr, rho=rho, epsilon=epsilon, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyAdagrad(var, accum, lr, grad, indices, use_locking, update_slots):
  return sparse_apply_adagrad(var=var, accum=accum, lr=lr, grad=grad, indices=indices, use_locking=use_locking, update_slots=update_slots)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyAdagradDA(var, gradient_accumulator, gradient_squared_accumulator, grad, indices, lr, l1, l2, global_step, use_locking):
  return sparse_apply_adagrad_da(var=var, gradient_accumulator=gradient_accumulator, gradient_squared_accumulator=gradient_squared_accumulator, grad=grad, indices=indices, lr=lr, l1=l1, l2=l2, global_step=global_step, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyCenteredRMSProp(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, indices, use_locking):
  return sparse_apply_centered_rms_prop(var=var, mg=mg, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyFtrl(var, accum, linear, grad, indices, lr, l1, l2, lr_power, use_locking):
  return sparse_apply_ftrl(var=var, accum=accum, linear=linear, grad=grad, indices=indices, lr=lr, l1=l1, l2=l2, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyFtrlV2(var, accum, linear, grad, indices, lr, l1, l2, l2_shrinkage, lr_power, use_locking):
  return sparse_apply_ftrl_v2(var=var, accum=accum, linear=linear, grad=grad, indices=indices, lr=lr, l1=l1, l2=l2, l2_shrinkage=l2_shrinkage, lr_power=lr_power, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyMomentum(var, accum, lr, grad, indices, momentum, use_locking, use_nesterov):
  return sparse_apply_momentum(var=var, accum=accum, lr=lr, grad=grad, indices=indices, momentum=momentum, use_locking=use_locking, use_nesterov=use_nesterov)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyProximalAdagrad(var, accum, lr, l1, l2, grad, indices, use_locking):
  return sparse_apply_proximal_adagrad(var=var, accum=accum, lr=lr, l1=l1, l2=l2, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyProximalGradientDescent(var, alpha, l1, l2, grad, indices, use_locking):
  return sparse_apply_proximal_gradient_descent(var=var, alpha=alpha, l1=l1, l2=l2, grad=grad, indices=indices, use_locking=use_locking)
...
@_doc_controls.do_not_generate_docs
@_kwarg_only
def SparseApplyRMSProp(var, ms, mom, lr, rho, momentum, epsilon, grad, indices, use_locking):
  return sparse_apply_rms_prop(var=var, ms=ms, mom=mom, lr=lr, rho=rho, momentum=momentum, epsilon=epsilon, grad=grad, indices=indices, use_locking=use_locking)
