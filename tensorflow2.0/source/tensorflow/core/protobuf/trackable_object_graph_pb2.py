...
TrackableObjectGraph = _reflection.GeneratedProtocolMessageType('TrackableObjectGraph', (_message.Message,), dict(

  TrackableObject = _reflection.GeneratedProtocolMessageType('TrackableObject', (_message.Message,), dict(
