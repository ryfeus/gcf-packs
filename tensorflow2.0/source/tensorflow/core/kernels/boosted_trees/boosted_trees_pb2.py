...
_sym_db.RegisterEnumDescriptor(_BUCKETIZEDSPLIT_DEFAULTDIRECTION)
...
_BUCKETIZEDSPLIT = _descriptor.Descriptor(
  ...
  nested_types=[],
  enum_types=[
    _BUCKETIZEDSPLIT_DEFAULTDIRECTION,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_CATEGORICALSPLIT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='left_id', full_name='tensorflow.boosted_trees.CategoricalSplit.left_id', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='right_id', full_name='tensorflow.boosted_trees.CategoricalSplit.right_id', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUCKETIZEDSPLIT.fields_by_name['default_direction'].enum_type = _BUCKETIZEDSPLIT_DEFAULTDIRECTION
_BUCKETIZEDSPLIT_DEFAULTDIRECTION.containing_type = _BUCKETIZEDSPLIT
...
CategoricalSplit = _reflection.GeneratedProtocolMessageType('CategoricalSplit', (_message.Message,), dict(
...
DenseSplit = _reflection.GeneratedProtocolMessageType('DenseSplit', (_message.Message,), dict(
...
DebugOutput = _reflection.GeneratedProtocolMessageType('DebugOutput', (_message.Message,), dict(
