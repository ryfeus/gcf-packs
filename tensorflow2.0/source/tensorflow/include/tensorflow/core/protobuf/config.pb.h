...
class GPUOptions_Experimental : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.GPUOptions.Experimental) */ {
 public:
  ...
  // int32 pending_cap = 6;
  void clear_pending_cap();
  static const int kPendingCapFieldNumber = 6;
  ::google::protobuf::int32 pending_cap() const;
  void set_pending_cap(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 pending_cap_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class RunMetadata_FunctionGraphs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.RunMetadata.FunctionGraphs) */ {
 public:
  ...
  inline RunMetadata_FunctionGraphs* New() const final {
    return CreateMaybeMessage<RunMetadata_FunctionGraphs>(NULL);
  }

  RunMetadata_FunctionGraphs* New(::google::protobuf::Arena* arena) const final {
...
class CallableOptions_FeedDevicesEntry_DoNotUse : public ::google::protobuf::internal::MapEntry<CallableOptions_FeedDevicesEntry_DoNotUse, 
    ::std::string, ::std::string,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    0 > {
public:
  typedef ::google::protobuf::internal::MapEntry<CallableOptions_FeedDevicesEntry_DoNotUse, 
    ::std::string, ::std::string,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    0 > SuperType;
  CallableOptions_FeedDevicesEntry_DoNotUse();
  CallableOptions_FeedDevicesEntry_DoNotUse(::google::protobuf::Arena* arena);
...
class CallableOptions_FetchDevicesEntry_DoNotUse : public ::google::protobuf::internal::MapEntry<CallableOptions_FetchDevicesEntry_DoNotUse, 
    ::std::string, ::std::string,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    0 > {
public:
  typedef ::google::protobuf::internal::MapEntry<CallableOptions_FetchDevicesEntry_DoNotUse, 
    ::std::string, ::std::string,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    0 > SuperType;
  CallableOptions_FetchDevicesEntry_DoNotUse();
  CallableOptions_FetchDevicesEntry_DoNotUse(::google::protobuf::Arena* arena);
...
// int32 pending_cap = 6;
inline void GPUOptions_Experimental::clear_pending_cap() {
  pending_cap_ = 0;
}
inline ::google::protobuf::int32 GPUOptions_Experimental::pending_cap() const {
  // @@protoc_insertion_point(field_get:tensorflow.GPUOptions.Experimental.pending_cap)
  return pending_cap_;
}
inline void GPUOptions_Experimental::set_pending_cap(::google::protobuf::int32 value) {
  
  pending_cap_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.GPUOptions.Experimental.pending_cap)
}
...
inline bool RunMetadata_FunctionGraphs::has_pre_optimization_graph() const {
  return this != internal_default_instance() && pre_optimization_graph_ != NULL;
}
...
inline void RunMetadata_FunctionGraphs::set_allocated_pre_optimization_graph(::tensorflow::GraphDef* pre_optimization_graph) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(pre_optimization_graph_);
  }
  if (pre_optimization_graph) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast<::google::protobuf::MessageLite*>(pre_optimization_graph)->GetArena();
    if (message_arena != submessage_arena) {
      pre_optimization_graph = ::google::protobuf::internal::GetOwnedMessage(
...
inline bool RunMetadata_FunctionGraphs::has_post_optimization_graph() const {
  return this != internal_default_instance() && post_optimization_graph_ != NULL;
}
...
inline void RunMetadata_FunctionGraphs::set_allocated_post_optimization_graph(::tensorflow::GraphDef* post_optimization_graph) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(post_optimization_graph_);
  }
  if (post_optimization_graph) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast<::google::protobuf::MessageLite*>(post_optimization_graph)->GetArena();
    if (message_arena != submessage_arena) {
      post_optimization_graph = ::google::protobuf::internal::GetOwnedMessage(
