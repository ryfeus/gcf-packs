...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorboard/compat/proto/tensor.proto',
  package='tensorboard',
  syntax='proto3',
...
_TENSORPROTO.fields_by_name['dtype'].enum_type = tensorboard_dot_compat_dot_proto_dot_types__pb2._DATATYPE
_TENSORPROTO.fields_by_name['tensor_shape'].message_type = tensorboard_dot_compat_dot_proto_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_TENSORPROTO.fields_by_name['resource_handle_val'].message_type = tensorboard_dot_compat_dot_proto_dot_resource__handle__pb2._RESOURCEHANDLEPROTO
