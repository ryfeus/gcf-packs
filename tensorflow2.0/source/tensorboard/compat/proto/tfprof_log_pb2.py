...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorboard/compat/proto/tfprof_log.proto',
  package='tensorboard',
  syntax='proto3',
  ...
  ,
  dependencies=[tensorboard_dot_compat_dot_proto_dot_attr__value__pb2.DESCRIPTOR,tensorboard_dot_compat_dot_proto_dot_step__stats__pb2.DESCRIPTOR,])
...
_PROFILENODE_ATTRSENTRY.fields_by_name['value'].message_type = tensorboard_dot_compat_dot_proto_dot_attr__value__pb2._ATTRVALUE
...
_EXECPROFILE.fields_by_name['allocations'].message_type = tensorboard_dot_compat_dot_proto_dot_step__stats__pb2._ALLOCATIONRECORD
