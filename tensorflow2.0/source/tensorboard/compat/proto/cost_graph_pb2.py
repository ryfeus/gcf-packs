...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorboard/compat/proto/cost_graph.proto',
  package='tensorboard',
  syntax='proto3',
...
_COSTGRAPHDEF_NODE_OUTPUTINFO.fields_by_name['shape'].message_type = tensorboard_dot_compat_dot_proto_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_COSTGRAPHDEF_NODE_OUTPUTINFO.fields_by_name['dtype'].enum_type = tensorboard_dot_compat_dot_proto_dot_types__pb2._DATATYPE
