...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorboard/compat/proto/graph.proto',
  package='tensorboard',
  syntax='proto3',
  ...
  serialized_pb=_b('\n$tensorboard/compat/proto/graph.proto\x12\x0btensorboard\x1a\'tensorboard/compat/proto/node_def.proto\x1a\'tensorboard/compat/proto/function.proto\x1a\'tensorboard/compat/proto/versions.proto\"\xa0\x01\n\x08GraphDef\x12\"\n\x04node\x18\x01 \x03(\x0b\x32\x14.tensorboard.NodeDef\x12)\n\x08versions\x18\x04 \x01(\x0b\x32\x17.tensorboard.VersionDef\x12\x13\n\x07version\x18\x03 \x01(\x05\x42\x02\x18\x01\x12\x30\n\x07library\x18\x02 \x01(\x0b\x32\x1f.tensorboard.FunctionDefLibraryBk\n\x18org.tensorflow.frameworkB\x0bGraphProtosP\x01Z=github.com/tensorflow/tensorflow/tensorflow/go/core/framework\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[tensorboard_dot_compat_dot_proto_dot_node__def__pb2.DESCRIPTOR,tensorboard_dot_compat_dot_proto_dot_function__pb2.DESCRIPTOR,tensorboard_dot_compat_dot_proto_dot_versions__pb2.DESCRIPTOR,])
...
_GRAPHDEF.fields_by_name['node'].message_type = tensorboard_dot_compat_dot_proto_dot_node__def__pb2._NODEDEF
_GRAPHDEF.fields_by_name['versions'].message_type = tensorboard_dot_compat_dot_proto_dot_versions__pb2._VERSIONDEF
_GRAPHDEF.fields_by_name['library'].message_type = tensorboard_dot_compat_dot_proto_dot_function__pb2._FUNCTIONDEFLIBRARY
