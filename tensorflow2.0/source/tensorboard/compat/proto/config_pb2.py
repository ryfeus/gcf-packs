...
_GPUOPTIONS_EXPERIMENTAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pending_cap', full_name='tensorboard.GPUOptions.Experimental.pending_cap', index=5,
...
RunMetadata = _reflection.GeneratedProtocolMessageType('RunMetadata', (_message.Message,), dict(
  ...
  FunctionGraphs = _reflection.GeneratedProtocolMessageType('FunctionGraphs', (_message.Message,), dict(
