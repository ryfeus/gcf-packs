...
NodeDef = _reflection.GeneratedProtocolMessageType('NodeDef', (_message.Message,), dict(
  ...
  ExperimentalDebugInfo = _reflection.GeneratedProtocolMessageType('ExperimentalDebugInfo', (_message.Message,), dict(
